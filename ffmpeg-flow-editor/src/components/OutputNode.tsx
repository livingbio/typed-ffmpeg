...
const outputOptions = options.filter(
  (option) => (option.flags & OUTPUT_FLAG) !== 0 && option.type !== 'OPT_TYPE_FUNC' // Skip function type options that can't be set through text input
);
