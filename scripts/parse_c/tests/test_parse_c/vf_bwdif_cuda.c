# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_cuda.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_cuda.c" 2
# 21 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_cuda.c"
...
# 22 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_cuda.c" 2
...
int av_hwframe_ctx_create_derived(AVBufferRef **derived_frame_ctx,
                                  ...
                                  int flags);
# 23 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_cuda.c" 2
...
# 24 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_cuda.c" 2
...
# 25 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_cuda.c" 2
...
# 26 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_cuda.c" 2
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/yadif.h" 1
# 22 "/Users/davidchen/repo/ffmpeg/libavfilter/yadif.h"
# 1 "./libavutil/opt.h" 1
# 223 "./libavutil/opt.h"
enum AVOptionType{
    AV_OPT_TYPE_FLAGS,
...
int av_opt_serialize(void *obj, int opt_flags, int flags, char **buffer,
                     const char key_val_sep, const char pairs_sep);
# 23 "/Users/davidchen/repo/ffmpeg/libavfilter/yadif.h" 2
...
# 24 "/Users/davidchen/repo/ffmpeg/libavfilter/yadif.h" 2
...
# 27 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_cuda.c" 2
...
# 29 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_cuda.c" 2
...
# 55 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_cuda.c"
                            ...
                            int parity, int tff, int clip_max)
{
    ...
    ret = ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuTexObjectCreate(&tex_prev, &res_desc, &tex_desc, ((void*)0))), "cu->cuTexObjectCreate(&tex_prev, &res_desc, &tex_desc, ((void*)0))");
    if (ret < 0)
        goto exit;

    res_desc.res.pitch2D.devPtr = (CUdeviceptr)cur;
    ret = ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuTexObjectCreate(&tex_cur, &res_desc, &tex_desc, ((void*)0))), "cu->cuTexObjectCreate(&tex_cur, &res_desc, &tex_desc, ((void*)0))");
    if (ret < 0)
        goto exit;

    res_desc.res.pitch2D.devPtr = (CUdeviceptr)next;
    ret = ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuTexObjectCreate(&tex_next, &res_desc, &tex_desc, ((void*)0))), "cu->cuTexObjectCreate(&tex_next, &res_desc, &tex_desc, ((void*)0))");
    if (ret < 0)
        goto exit;

    ret = ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuLaunchKernel(func, ( ((dst_width) + (32) - 1) / (32) ), ( ((dst_height) + (16) - 1) / (16) ), 1, 32, 16, 1, 0, s->hwctx->stream, args, ((void*)0))), "cu->cuLaunchKernel(func, ( ((dst_width) + (32) - 1) / (32) ), ( ((dst_height) + (16) - 1) / (16) ), 1, 32, 16, 1, 0, s->hwctx->stream, args, ((void*)0))");
...
exit:
    if (tex_prev)
        ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuTexObjectDestroy(tex_prev)), "cu->cuTexObjectDestroy(tex_prev)");
    if (tex_cur)
        ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuTexObjectDestroy(tex_cur)), "cu->cuTexObjectDestroy(tex_cur)");
    if (tex_next)
        ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuTexObjectDestroy(tex_next)), "cu->cuTexObjectDestroy(tex_next)");
                   ...
                   int parity, int tff)
{
    ...
    ret = ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuCtxPushCurrent(s->hwctx->cuda_ctx)), "cu->cuCtxPushCurrent(s->hwctx->cuda_ctx)");
    if (ret < 0)
        return;
    ...
    for (i = 0; i < y->csp->nb_components; i++) {
        ...
        if (pixel_size > 2 || channels > 2) {
            av_log(ctx, 16, "Unsupported pixel format: %s\n", y->csp->name);
            goto exit;
        }
        switch (pixel_size) {
        case 1:
        ...
        call_kernel(ctx, func,
                    ...
                    format, channels,
                    (!__builtin_constant_p(i ? y->csp->log2_chroma_w : 0) ? -((-(y->cur->width)) >> (i ? y->csp->log2_chroma_w : 0)) : ((y->cur->width) + (1<<(i ? y->csp->log2_chroma_w : 0)) - 1) >> (i ? y->csp->log2_chroma_w : 0)),
                    (!__builtin_constant_p(i ? y->csp->log2_chroma_h : 0) ? -((-(y->cur->height)) >> (i ? y->csp->log2_chroma_h : 0)) : ((y->cur->height) + (1<<(i ? y->csp->log2_chroma_h : 0)) - 1) >> (i ? y->csp->log2_chroma_h : 0)),
                    y->cur->linesize[i],
                    (CUdeviceptr)dst->data[i],
                    (!__builtin_constant_p(i ? y->csp->log2_chroma_w : 0) ? -((-(dst->width)) >> (i ? y->csp->log2_chroma_w : 0)) : ((dst->width) + (1<<(i ? y->csp->log2_chroma_w : 0)) - 1) >> (i ? y->csp->log2_chroma_w : 0)),
                    (!__builtin_constant_p(i ? y->csp->log2_chroma_h : 0) ? -((-(dst->height)) >> (i ? y->csp->log2_chroma_h : 0)) : ((dst->height) + (1<<(i ? y->csp->log2_chroma_h : 0)) - 1) >> (i ? y->csp->log2_chroma_h : 0)),
...
exit:
    ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuCtxPopCurrent(&dummy)), "cu->cuCtxPopCurrent(&dummy)");
    return;
}

static __attribute__((cold)) void deint_cuda_uninit(AVFilterContext *ctx)
{
    CUcontext dummy;
    DeintCUDAContext *s = ctx->priv;
    YADIFContext *y = &s->yadif;
    ...
    if (s->hwctx && s->cu_module) {
        CudaFunctions *cu = s->hwctx->internal->cuda_dl;
        ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuCtxPushCurrent(s->hwctx->cuda_ctx)), "cu->cuCtxPushCurrent(s->hwctx->cuda_ctx)");
        ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuModuleUnload(s->cu_module)), "cu->cuModuleUnload(s->cu_module)");
        ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuCtxPopCurrent(&dummy)), "cu->cuCtxPopCurrent(&dummy)");
    }
...
static int config_input(AVFilterLink *inlink)
{
    ...
    if (!inlink->hw_frames_ctx) {
        av_log(ctx, 16, "A hardware frames reference is "
    ...
    if (!s->input_frames_ref) {
        av_log(ctx, 16, "A input frames reference create "
               "failed.\n");
        return (-(12));
    }
...
static int config_output(AVFilterLink *link)
{
    ...
    do { if (!(s->input_frames)) { av_log(((void*)0), 0, "Assertion %s failed at %s:%d\n", "s->input_frames", "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_cuda.c", 253); abort(); } } while (0);
    s->device_ref = av_buffer_ref(s->input_frames->device_ref);
    if (!s->device_ref) {
        av_log(ctx, 16, "A device reference create "
               "failed.\n");
        return (-(12));
    }
    ...
    if (!link->hw_frames_ctx) {
        av_log(ctx, 16, "Failed to create HW frame context "
               "for output.\n");
        ret = (-(12));
        goto exit;
    }
    ...
    if (ret < 0) {
        av_log(ctx, 16, "Failed to initialise CUDA frame "
    ...
    if ((!__builtin_constant_p(y->csp->log2_chroma_w) ? -((-(link->w)) >> (y->csp->log2_chroma_w)) : ((link->w) + (1<<(y->csp->log2_chroma_w)) - 1) >> (y->csp->log2_chroma_w)) < 3 || (!__builtin_constant_p(y->csp->log2_chroma_h) ? -((-(link->h)) >> (y->csp->log2_chroma_h)) : ((link->h) + (1<<(y->csp->log2_chroma_h)) - 1) >> (y->csp->log2_chroma_h)) < 3) {
        av_log(ctx, 16, "Video with planes less than 3 columns or lines is not supported\n");
        ret = (-(22));
        goto exit;
    }
    ...
    ret = ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuModuleGetFunction(&s->cu_func_uchar, s->cu_module, "bwdif_uchar")), "cu->cuModuleGetFunction(&s->cu_func_uchar, s->cu_module, \"bwdif_uchar\")");
    if (ret < 0)
        goto exit;

    ret = ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuModuleGetFunction(&s->cu_func_uchar2, s->cu_module, "bwdif_uchar2")), "cu->cuModuleGetFunction(&s->cu_func_uchar2, s->cu_module, \"bwdif_uchar2\")");
    if (ret < 0)
        goto exit;

    ret = ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuModuleGetFunction(&s->cu_func_ushort, s->cu_module, "bwdif_ushort")), "cu->cuModuleGetFunction(&s->cu_func_ushort, s->cu_module, \"bwdif_ushort\")");
    if (ret < 0)
        goto exit;

    ret = ff_cuda_check(ctx, s->hwctx->internal->cuda_dl->cuGetErrorName, s->hwctx->internal->cuda_dl->cuGetErrorString, (cu->cuModuleGetFunction(&s->cu_func_ushort2, s->cu_module, "bwdif_ushort2")), "cu->cuModuleGetFunction(&s->cu_func_ushort2, s->cu_module, \"bwdif_ushort2\")");
    if (ret < 0)
        goto exit;
...
const AVFilter ff_vf_bwdif_cuda = {
    .name = "bwdif_cuda",
    .description = "Deinterlace CUDA frames",
    ...
    .inputs = (deint_cuda_inputs), .nb_inputs = (sizeof((deint_cuda_inputs)) / sizeof(((deint_cuda_inputs))[0])),
    .outputs = (deint_cuda_outputs), .nb_outputs = (sizeof((deint_cuda_outputs)) / sizeof(((deint_cuda_outputs))[0])),
    .flags = (1 << 17),
    .flags_internal = (1 << 0),
};
