# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/split.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/split.c" 2
# 26 "/Users/davidchen/repo/ffmpeg/libavfilter/split.c"
...
# 27 "/Users/davidchen/repo/ffmpeg/libavfilter/split.c" 2

# 1 "./libavutil/attributes.h" 1
# 29 "/Users/davidchen/repo/ffmpeg/libavfilter/split.c" 2
...
# 30 "/Users/davidchen/repo/ffmpeg/libavfilter/split.c" 2
...
# 44 "./libavutil/internal.h" 2
# 1 "./libavutil/pixfmt.h" 1
# 30 "./libavutil/pixfmt.h"
...
# 31 "/Users/davidchen/repo/ffmpeg/libavfilter/split.c" 2
# 1 "./libavutil/opt.h" 1
# 31 "./libavutil/opt.h"
...
int av_opt_serialize(void *obj, int opt_flags, int flags, char **buffer,
                     const char key_val_sep, const char pairs_sep);
# 32 "/Users/davidchen/repo/ffmpeg/libavfilter/split.c" 2
...
# 34 "/Users/davidchen/repo/ffmpeg/libavfilter/split.c" 2
...
# 35 "/Users/davidchen/repo/ffmpeg/libavfilter/split.c" 2
...
# 36 "/Users/davidchen/repo/ffmpeg/libavfilter/split.c" 2
...
# 38 "/Users/davidchen/repo/ffmpeg/libavfilter/split.c" 2
...
static __attribute__((cold)) int split_init(AVFilterContext *ctx)
{
...
static int activate(AVFilterContext *ctx)
{
    ...
    for (int i = 0; i < ctx->nb_outputs; i++)
        nb_eofs += ff_outlink_get_status(ctx->outputs[i]) == (-(int)(('E') | (('O') << 8) | (('F') << 16) | ((unsigned)(' ') << 24)));

    if (nb_eofs == ctx->nb_outputs) {
        ff_inlink_set_status(inlink, (-(int)(('E') | (('O') << 8) | (('F') << 16) | ((unsigned)(' ') << 24))));
        return 0;
    }
...
static const AVOption options[] = {
    { "outputs", "set number of outputs", __builtin_offsetof(SplitContext, nb_outputs), AV_OPT_TYPE_INT, { .i64 = 2 }, 1, 2147483647, (8 | 16 | (1<<16)) },
    { ((void*)0) }
};

static const AVClass split_class = { .class_name = "(a)split", .item_name = av_default_item_name, .option = options, .version = ((58)<<16 | (36)<<8 | (100)), .category = AV_CLASS_CATEGORY_FILTER, };
...
const AVFilter ff_vf_split = {
    ...
    .init = split_init,
    .activate = activate,
    .inputs = (ff_video_default_filterpad), .nb_inputs = (sizeof((ff_video_default_filterpad)) / sizeof(((ff_video_default_filterpad))[0])),
    .outputs = ((void*)0),
    .flags = (1 << 1) | (1 << 3),
};
