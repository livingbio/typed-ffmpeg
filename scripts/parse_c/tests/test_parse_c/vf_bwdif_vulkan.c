# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_vulkan.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_vulkan.c" 2
# 23 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_vulkan.c"
# 1 "./libavutil/random_seed.h" 1
# 24 "./libavutil/random_seed.h"
...
# 26 "./libavutil/random_seed.h" 2
# 38 "./libavutil/random_seed.h"
uint32_t av_get_random_seed(void);
# 51 "./libavutil/random_seed.h"
int av_random_bytes(uint8_t *buf, size_t len);
# 24 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_vulkan.c" 2
# 1 "./libavutil/opt.h" 1
# 30 "./libavutil/opt.h"
...
int av_opt_serialize(void *obj, int opt_flags, int flags, char **buffer,
                     const char key_val_sep, const char pairs_sep);
# 25 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_vulkan.c" 2
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vulkan_filter.h" 1
# 24 "/Users/davidchen/repo/ffmpeg/libavfilter/vulkan_filter.h"
...
# 25 "/Users/davidchen/repo/ffmpeg/libavfilter/vulkan_filter.h" 2
...
# 25 "./libavutil/thread.h"
# 1 "./config.h" 1
# 26 "./libavutil/thread.h" 2
...
int ff_vk_filter_process_Nin(FFVulkanContext *vkctx, FFVkExecPool *e,
                             ...
                             VkSampler sampler, void *push_src, size_t push_size);
# 26 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_vulkan.c" 2
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vulkan_spirv.h" 1
# 27 "/Users/davidchen/repo/ffmpeg/libavfilter/vulkan_spirv.h"
...
# 27 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_vulkan.c" 2
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/yadif.h" 1
# 25 "/Users/davidchen/repo/ffmpeg/libavfilter/yadif.h"
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/ccfifo.h" 1
# 34 "/Users/davidchen/repo/ffmpeg/libavfilter/ccfifo.h"
...
# 35 "/Users/davidchen/repo/ffmpeg/libavfilter/ccfifo.h" 2
...
# 55 "/Users/davidchen/repo/ffmpeg/libavfilter/ccfifo.h"
...
# 77 "/Users/davidchen/repo/ffmpeg/libavfilter/ccfifo.h"
...
# 91 "/Users/davidchen/repo/ffmpeg/libavfilter/ccfifo.h"
int ff_ccfifo_getoutputsize(const CCFifo *ccf);
# 104 "/Users/davidchen/repo/ffmpeg/libavfilter/ccfifo.h"
...
# 26 "/Users/davidchen/repo/ffmpeg/libavfilter/yadif.h" 2
...
# 28 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_vulkan.c" 2
...
# 29 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_bwdif_vulkan.c" 2
...
static __attribute__((cold)) int init_filter(AVFilterContext *ctx)
{
    int err;
    uint8_t *spv_data;
    size_t spv_len;
    void *spv_opaque = ((void*)0);
    ...
    if (!spv) {
        av_log(ctx, 16, "Unable to initialize SPIR-V compiler!\n");
        return (-(int)(('E') | (('X') << 8) | (('T') << 16) | ((unsigned)(' ') << 24)));
    }

    ff_vk_qf_init(vkctx, &s->qf, VK_QUEUE_COMPUTE_BIT);
    do { if ((err = (ff_vk_exec_pool_init(vkctx, &s->qf, &s->e, s->qf.nb_queues*4, 0, 0, 0, ((void*)0)))) < 0) goto fail; } while (0);
    do { if ((err = (ff_vk_init_sampler(vkctx, &s->sampler, 1, VK_FILTER_NEAREST))) < 0) goto fail; } while (0);
    do { if ((err = (ff_vk_shader_init(&s->pl, &s->shd, "bwdif_compute", VK_SHADER_STAGE_COMPUTE_BIT, 0))) < 0) goto fail; } while (0);
    ...
    desc = (FFVulkanDescriptorSetBinding []) {
        {
            ...
            .samplers = { s->sampler, s->sampler, s->sampler, s->sampler },
        },
        {
            .name = "cur",
            .type = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
    ...
    do { if ((err = (ff_vk_pipeline_descriptor_set_add(vkctx, &s->pl, shd, desc, 4, 0, 0))) < 0) goto fail; } while (0);

    do { av_bprintf(&shd->src, "layout(push_constant, std430) uniform pushConstants {" "\n"); } while (0);
    do { av_bprintf(&shd->src, "    " "int parity;" "\n"); } while (0);
    do { av_bprintf(&shd->src, "    " "int tff;" "\n"); } while (0);
    do { av_bprintf(&shd->src, "    " "int current_field;" "\n"); } while (0);
    do { av_bprintf(&shd->src, "};" "\n"); } while (0);

    ff_vk_add_push_constant(&s->pl, 0, sizeof(BWDIFParameters),
                            VK_SHADER_STAGE_COMPUTE_BIT);

    do { av_bprintf(&shd->src, "\n"); av_bprint_append_data(&shd->src, filter_fn, strlen(filter_fn)); av_bprintf(&shd->src, "\n"); } while (0);
    do { av_bprintf(&shd->src, "void main()" "\n"); } while (0);
    do { av_bprintf(&shd->src, "{" "\n"); } while (0);
    do { av_bprintf(&shd->src, "    " "vec4 res;" "\n"); } while (0);
    do { av_bprintf(&shd->src, "    " "ivec2 size;" "\n"); } while (0);
    do { av_bprintf(&shd->src, "    " "vec4 dcur[4];" "\n"); } while (0);
    do { av_bprintf(&shd->src, "    " "vec4 prev1[2];" "\n"); } while (0);
    do { av_bprintf(&shd->src, "    " "vec4 next1[2];" "\n"); } while (0);
    do { av_bprintf(&shd->src, "    " "vec4 prev2[5];" "\n"); } while (0);
    do { av_bprintf(&shd->src, "    " "vec4 next2[5];" "\n"); } while (0);
    do { av_bprintf(&shd->src, "    " "const ivec2 pos = ivec2(gl_GlobalInvocationID.xy);" "\n"); } while (0);
    do { av_bprintf(&shd->src, "    " "bool filter_field = ((pos.y ^ parity) & 1) == 1;" "\n"); } while (0);
    do { av_bprintf(&shd->src, "    " "bool is_intra = filter_field && (current_field == %i);" "\n", YADIF_FIELD_END); } while (0);
    do { av_bprintf(&shd->src, "    " "bool field_parity = (parity ^ tff) != 0;" "\n"); } while (0);
    do { av_bprintf(&shd->src, "" "\n"); } while (0);

    for (int i = 0; i < planes; i++) {
        do { av_bprintf(&shd->src, "" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "size = imageSize(dst[%i]);" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "if (!IS_WITHIN(pos, size)) {" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "return;" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "} else if (is_intra) {" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "dcur[0] = texture(cur[%i], pos - ivec2(0, 3));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "dcur[1] = texture(cur[%i], pos - ivec2(0, 1));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "dcur[2] = texture(cur[%i], pos + ivec2(0, 1));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "dcur[3] = texture(cur[%i], pos + ivec2(0, 3));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "res = process_intra(dcur);" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "imageStore(dst[%i], pos, res);" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "} else if (filter_field) {" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "dcur[0] = texture(cur[%i], pos - ivec2(0, 3));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "dcur[1] = texture(cur[%i], pos - ivec2(0, 1));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "dcur[2] = texture(cur[%i], pos + ivec2(0, 1));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "dcur[3] = texture(cur[%i], pos + ivec2(0, 3));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "prev1[0] = texture(prev[%i], pos - ivec2(0, 1));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "prev1[1] = texture(prev[%i], pos + ivec2(0, 1));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "next1[0] = texture(next[%i], pos - ivec2(0, 1));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "next1[1] = texture(next[%i], pos + ivec2(0, 1));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "if (field_parity) {" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "prev2[0] = texture(prev[%i], pos - ivec2(0, 4));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "prev2[1] = texture(prev[%i], pos - ivec2(0, 2));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "prev2[2] = texture(prev[%i], pos);" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "prev2[3] = texture(prev[%i], pos + ivec2(0, 2));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "prev2[4] = texture(prev[%i], pos + ivec2(0, 4));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "next2[0] = texture(cur[%i], pos - ivec2(0, 4));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "next2[1] = texture(cur[%i], pos - ivec2(0, 2));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "next2[2] = texture(cur[%i], pos);" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "next2[3] = texture(cur[%i], pos + ivec2(0, 2));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "next2[4] = texture(cur[%i], pos + ivec2(0, 4));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "} else {" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "prev2[0] = texture(cur[%i], pos - ivec2(0, 4));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "prev2[1] = texture(cur[%i], pos - ivec2(0, 2));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "prev2[2] = texture(cur[%i], pos);" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "prev2[3] = texture(cur[%i], pos + ivec2(0, 2));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "prev2[4] = texture(cur[%i], pos + ivec2(0, 4));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "next2[0] = texture(next[%i], pos - ivec2(0, 4));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "next2[1] = texture(next[%i], pos - ivec2(0, 2));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "next2[2] = texture(next[%i], pos);" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "next2[3] = texture(next[%i], pos + ivec2(0, 2));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "    " "next2[4] = texture(next[%i], pos + ivec2(0, 4));" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "}" "\n"); } while (0);
        do { av_bprintf(&shd->src, "" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "res = process_line(prev2, prev1, dcur, next1, next2);" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "imageStore(dst[%i], pos, res);" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "} else {" "\n"); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "res = texture(cur[%i], pos);" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "    " "imageStore(dst[%i], pos, res);" "\n", i); } while (0);
        do { av_bprintf(&shd->src, "    " "}" "\n"); } while (0);
    }
    ...
    do { if ((err = (spv->compile_shader(spv, ctx, &s->shd, &spv_data, &spv_len, "main", &spv_opaque))) < 0) goto fail; } while (0);

    do { if ((err = (ff_vk_shader_create(vkctx, &s->shd, spv_data, spv_len, "main"))) < 0) goto fail; } while (0);

    do { if ((err = (ff_vk_init_compute_pipeline(vkctx, &s->pl, &s->shd))) < 0) goto fail; } while (0);
    do { if ((err = (ff_vk_exec_pipeline_register(vkctx, &s->e, &s->pl))) < 0) goto fail; } while (0);
...
static int bwdif_vulkan_config_input(AVFilterLink *inlink)
{
    ...
    if (!inlink->hw_frames_ctx) {
        av_log(inlink->dst, 16, "Vulkan filtering requires a "
...
static int bwdif_vulkan_config_output(AVFilterLink *outlink)
{
    ...
    if ((!__builtin_constant_p(y->csp->log2_chroma_w) ? -((-(outlink->w)) >> (y->csp->log2_chroma_w)) : ((outlink->w) + (1<<(y->csp->log2_chroma_w)) - 1) >> (y->csp->log2_chroma_w)) < 4 || (!__builtin_constant_p(y->csp->log2_chroma_h) ? -((-(outlink->h)) >> (y->csp->log2_chroma_h)) : ((outlink->h) + (1<<(y->csp->log2_chroma_h)) - 1) >> (y->csp->log2_chroma_h)) < 4) {
        av_log(avctx, 16, "Video with planes less than 4 columns or lines is not supported\n");
        return (-(22));
    }
...
const AVFilter ff_vf_bwdif_vulkan = {
    ...
    .inputs = (bwdif_vulkan_inputs), .nb_inputs = (sizeof((bwdif_vulkan_inputs)) / sizeof(((bwdif_vulkan_inputs))[0])),
    .outputs = (bwdif_vulkan_outputs), .nb_outputs = (sizeof((bwdif_vulkan_outputs)) / sizeof(((bwdif_vulkan_outputs))[0])),
    .formats.pix_fmt = AV_PIX_FMT_VULKAN, .formats_state = FF_FILTER_FORMATS_SINGLE_PIXFMT,
