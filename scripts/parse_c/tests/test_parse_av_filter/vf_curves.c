# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c" 2
# 21 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c"
# 1 "./libavutil/opt.h" 1
# 30 "./libavutil/opt.h"
...
int av_opt_serialize(void *obj, int opt_flags, int flags, char **buffer,
                     const char key_val_sep, const char pairs_sep);
# 22 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c" 2
...
void av_bprint_escape(AVBPrint *dstbuf, const char *src, const char *special_chars,
                      enum AVEscapeMode mode, int flags);
# 23 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c" 2
...
# 24 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c" 2
...
# 25 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c" 2
...
# 26 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c" 2
...
# 27 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c" 2
# 1 "./libavutil/avassert.h" 1
# 76 "./libavutil/avassert.h"
void av_assert0_fpu(void);
# 28 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c" 2
...
# 29 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c" 2
...
# 30 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c" 2
...
# 31 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c" 2
...
# 32 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c" 2
...
# 33 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c" 2
...
static const AVOption curves_options[] = {
    { "preset", "select a color curves preset", __builtin_offsetof(CurvesContext, preset), AV_OPT_TYPE_INT, {.i64=PRESET_NONE}, PRESET_NONE, NB_PRESETS-1, (1<<16)|16|(1<<15), "preset_name" },
        { "none", ((void*)0), 0, AV_OPT_TYPE_CONST, {.i64=PRESET_NONE}, 0, 0, (1<<16)|16|(1<<15), "preset_name" },
        { "color_negative", ((void*)0), 0, AV_OPT_TYPE_CONST, {.i64=PRESET_COLOR_NEGATIVE}, 0, 0, (1<<16)|16|(1<<15), "preset_name" },
        { "cross_process", ((void*)0), 0, AV_OPT_TYPE_CONST, {.i64=PRESET_CROSS_PROCESS}, 0, 0, (1<<16)|16|(1<<15), "preset_name" },
        { "darker", ((void*)0), 0, AV_OPT_TYPE_CONST, {.i64=PRESET_DARKER}, 0, 0, (1<<16)|16|(1<<15), "preset_name" },
        { "increase_contrast", ((void*)0), 0, AV_OPT_TYPE_CONST, {.i64=PRESET_INCREASE_CONTRAST}, 0, 0, (1<<16)|16|(1<<15), "preset_name" },
        { "lighter", ((void*)0), 0, AV_OPT_TYPE_CONST, {.i64=PRESET_LIGHTER}, 0, 0, (1<<16)|16|(1<<15), "preset_name" },
        { "linear_contrast", ((void*)0), 0, AV_OPT_TYPE_CONST, {.i64=PRESET_LINEAR_CONTRAST}, 0, 0, (1<<16)|16|(1<<15), "preset_name" },
        { "medium_contrast", ((void*)0), 0, AV_OPT_TYPE_CONST, {.i64=PRESET_MEDIUM_CONTRAST}, 0, 0, (1<<16)|16|(1<<15), "preset_name" },
        { "negative", ((void*)0), 0, AV_OPT_TYPE_CONST, {.i64=PRESET_NEGATIVE}, 0, 0, (1<<16)|16|(1<<15), "preset_name" },
        { "strong_contrast", ((void*)0), 0, AV_OPT_TYPE_CONST, {.i64=PRESET_STRONG_CONTRAST}, 0, 0, (1<<16)|16|(1<<15), "preset_name" },
        { "vintage", ((void*)0), 0, AV_OPT_TYPE_CONST, {.i64=PRESET_VINTAGE}, 0, 0, (1<<16)|16|(1<<15), "preset_name" },
    { "master","set master points coordinates",__builtin_offsetof(CurvesContext, comp_points_str[3]), AV_OPT_TYPE_STRING, {.str=((void*)0)}, .flags = (1<<16)|16|(1<<15) },
    { "m", "set master points coordinates",__builtin_offsetof(CurvesContext, comp_points_str[3]), AV_OPT_TYPE_STRING, {.str=((void*)0)}, .flags = (1<<16)|16|(1<<15) },
    { "red", "set red points coordinates", __builtin_offsetof(CurvesContext, comp_points_str[0]), AV_OPT_TYPE_STRING, {.str=((void*)0)}, .flags = (1<<16)|16|(1<<15) },
    { "r", "set red points coordinates", __builtin_offsetof(CurvesContext, comp_points_str[0]), AV_OPT_TYPE_STRING, {.str=((void*)0)}, .flags = (1<<16)|16|(1<<15) },
    { "green", "set green points coordinates", __builtin_offsetof(CurvesContext, comp_points_str[1]), AV_OPT_TYPE_STRING, {.str=((void*)0)}, .flags = (1<<16)|16|(1<<15) },
    { "g", "set green points coordinates", __builtin_offsetof(CurvesContext, comp_points_str[1]), AV_OPT_TYPE_STRING, {.str=((void*)0)}, .flags = (1<<16)|16|(1<<15) },
    { "blue", "set blue points coordinates", __builtin_offsetof(CurvesContext, comp_points_str[2]), AV_OPT_TYPE_STRING, {.str=((void*)0)}, .flags = (1<<16)|16|(1<<15) },
    { "b", "set blue points coordinates", __builtin_offsetof(CurvesContext, comp_points_str[2]), AV_OPT_TYPE_STRING, {.str=((void*)0)}, .flags = (1<<16)|16|(1<<15) },
    { "all", "set points coordinates for all components", __builtin_offsetof(CurvesContext, comp_points_str_all), AV_OPT_TYPE_STRING, {.str=((void*)0)}, .flags = (1<<16)|16|(1<<15) },
    { "psfile", "set Photoshop curves file name", __builtin_offsetof(CurvesContext, psfile), AV_OPT_TYPE_STRING, {.str=((void*)0)}, .flags = (1<<16)|16|(1<<15) },
    { "plot", "save Gnuplot script of the curves in specified file", __builtin_offsetof(CurvesContext, plot_filename), AV_OPT_TYPE_STRING, {.str=((void*)0)}, .flags = (1<<16)|16|(1<<15) },
    { "interp", "specify the kind of interpolation", __builtin_offsetof(CurvesContext, interp), AV_OPT_TYPE_INT, {.i64=INTERP_NATURAL}, INTERP_NATURAL, NB_INTERPS-1, (1<<16)|16|(1<<15), "interp_name" },
        { "natural", "natural cubic spline", 0, AV_OPT_TYPE_CONST, {.i64=INTERP_NATURAL}, 0, 0, (1<<16)|16|(1<<15), "interp_name" },
        { "pchip", "monotonically cubic interpolation", 0, AV_OPT_TYPE_CONST, {.i64=INTERP_PCHIP}, 0, 0, (1<<16)|16|(1<<15), "interp_name" },
    { ((void*)0) }
};

static const AVClass curves_class = { .class_name = "curves", .item_name = av_default_item_name, .option = curves_options, .version = ((58)<<16 | (36)<<8 | (100)), .category = AV_CLASS_CATEGORY_FILTER, };
                            ...
                            int lut_size)
{
    ...
    while (p && *p) {
        ...
        if (point->x < 0 || point->x > 1 || point->y < 0 || point->y > 1) {
            av_log(ctx, 16, "Invalid key point coordinates (%f;%f), "
        ...
        if (last) {
            if ((int)(last->x * scale) >= (int)(point->x * scale)) {
                av_log(ctx, 16, "Key point coordinates (%f;%f) "
    ...
    if (*points && !(*points)->next) {
        av_log(ctx, 24, "Only one point (at (%f;%f)) is defined, "
...
# 229 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c"
                              ...
                              const struct keypoint *points, int nbits)
{
    ...
    if (n == 1) {
        for (i = 0; i < lut_size; i++)
            y[i] = (nbits == 8 ? av_clip_uint8_c(point->y * scale) : av_clip_uintp2_c(point->y * scale, nbits));
        return 0;
    }
    ...
    i = 0;
    do { if (!(point->next)) { av_log(((void*)0), 0, "Assertion %s failed at %s:%d\n", "point->next", "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c", 312); abort(); } } while (0);
    while (point->next) {
        ...
        do { if (!(x_start >= 0 && x_start < lut_size && x_end >= 0 && x_end < lut_size)) { av_log(((void*)0), 0, "Assertion %s failed at %s:%d\n", "x_start >= 0 && x_start < lut_size && x_end >= 0 && x_end < lut_size", "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c", 327); abort(); } } while (0);


        for (x = x_start; x <= x_end; x++) {
            const double xx = (x - x_start) * 1./scale;
            const double yy = a + b*xx + c*xx*xx + d*xx*xx*xx;
            y[x] = (nbits == 8 ? av_clip_uint8_c(yy * scale) : av_clip_uintp2_c(yy * scale, nbits));
...
# 368 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c"
static double pchip_edge_case(double h0, double h1, double m0, double m1)
{
    ...
    mask = (d > 0.0 ? 1 : d < 0.0 ? -1 : 0) != (m0 > 0.0 ? 1 : m0 < 0.0 ? -1 : 0);
    mask2 = ((m0 > 0.0 ? 1 : m0 < 0.0 ? -1 : 0) != (m1 > 0.0 ? 1 : m1 < 0.0 ? -1 : 0)) && (fabs(d) > 3. * fabs(m0));
...
# 397 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c"
static int pchip_find_derivatives(const int n, const double *hk, const double *mk, double *dk)
{
    ...
    for (int i = 0; i < n; i++) smk[i] = (mk[i] > 0.0 ? 1 : mk[i] < 0.0 ? -1 : 0);
...
# 441 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c"
...
# 462 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c"
                                    ...
                                    const struct keypoint *points, int nbits)
{
    ...
    if (n == 1) {
        ...
        const uint16_t yval = (nbits == 8 ? av_clip_uint8_c(point->y * scale) : av_clip_uintp2_c(point->y * scale, nbits));
    ...
    if (n == 2) {
        ...
        for (int i = 0; i < lut_size; i++) y[i] = (nbits == 8 ? av_clip_uint8_c(i*m + b) : av_clip_uintp2_c(i*m + b, nbits));
        goto end;
    }
    ...
    if (xi[0] > 0) {
        ...
        const uint16_t yval = (nbits == 8 ? av_clip_uint8_c(yi0) : av_clip_uintp2_c(yi0, nbits));
        for (; x < xi0; x++) {
            y[x] = yval;
            av_log(log_ctx, 56, "f(%f)=%f -> y[%d]=%d\n", xi0, yi0, x, y[x]);
        }
        av_log(log_ctx, 48, "Interval -1: [0, %d] -> %d\n", x - 1, yval);
    }
    ...
    for (int i = 0, x0 = x; i < n-1; i++, x0 = x) {
        ...
        for (; x < xi1; x++) {
            ...
            y[x] = (nbits == 8 ? av_clip_uint8_c(yy) : av_clip_uintp2_c(yy, nbits));
            av_log(log_ctx, 56, "f(%f)=%f -> y[%d]=%d\n", xx, yy, x, y[x]);
        }

        if (x > x0)
            av_log(log_ctx, 48, "Interval %d: [%d, %d] -> [%d, %d]\n",
                                                    i, x0, x-1, y[x0], y[x-1]);
        else
            av_log(log_ctx, 48, "Interval %d: empty\n", i);
    }
    ...
    if (x && x < lut_size) {
        ...
        const uint16_t yval = (nbits == 8 ? av_clip_uint8_c(yi1) : av_clip_uintp2_c(yi1, nbits));
        av_log(log_ctx, 48, "Interval %d: [%d, %d] -> %d\n",
...
static int parse_psfile(AVFilterContext *ctx, const char *fname)
{
    ...
    av_bprint_init(&ptstr, 0, 1);

    ret = av_file_map(fname, &buf, &size, 0, ((void*)0));
    if (ret < 0)
        return ret;
# 608 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c"
    do { if (size < 2) { ret = (-(int)(('I') | (('N') << 8) | (('D') << 16) | ((unsigned)('A') << 24))); goto end; } version = av_bswap16((((const union unaligned_16 *) (buf))->l)); buf += 2; size -= 2; } while (0);
    do { if (size < 2) { ret = (-(int)(('I') | (('N') << 8) | (('D') << 16) | ((unsigned)('A') << 24))); goto end; } nb_curves = av_bswap16((((const union unaligned_16 *) (buf))->l)); buf += 2; size -= 2; } while (0);
    for (i = 0; i < ((nb_curves) > ((sizeof(comp_ids) / sizeof((comp_ids)[0]))) ? ((sizeof(comp_ids) / sizeof((comp_ids)[0]))) : (nb_curves)); i++) {
        int nb_points, n;
        av_bprint_clear(&ptstr);
        do { if (size < 2) { ret = (-(int)(('I') | (('N') << 8) | (('D') << 16) | ((unsigned)('A') << 24))); goto end; } nb_points = av_bswap16((((const union unaligned_16 *) (buf))->l)); buf += 2; size -= 2; } while (0);
        for (n = 0; n < nb_points; n++) {
            int y, x;
            do { if (size < 2) { ret = (-(int)(('I') | (('N') << 8) | (('D') << 16) | ((unsigned)('A') << 24))); goto end; } y = av_bswap16((((const union unaligned_16 *) (buf))->l)); buf += 2; size -= 2; } while (0);
            do { if (size < 2) { ret = (-(int)(('I') | (('N') << 8) | (('D') << 16) | ((unsigned)('A') << 24))); goto end; } x = av_bswap16((((const union unaligned_16 *) (buf))->l)); buf += 2; size -= 2; } while (0);
        ...
        if (*ptstr.str) {
            ...
            if (!*pts) {
                *pts = av_strdup(ptstr.str);
                av_log(ctx, 48, "curves %d (intid=%d) [%d points]: [%s]\n",
    ...
    av_bprint_finalize(&ptstr, ((void*)0));
    av_file_unmap(buf, size);
    return ret;
}

static int dump_curves(const char *fname, uint16_t *graph[3 + 1],
                       struct keypoint *comp_points[3 + 1],
                       int lut_size)
{
    int i;
    AVBPrint buf;
    ...
    do { if (!((sizeof(colors) / sizeof((colors)[0])) == 3 + 1)) { av_log(((void*)0), 0, "Assertion %s failed at %s:%d\n", "(sizeof(colors) / sizeof((colors)[0])) == 3 + 1", "/Users/davidchen/repo/ffmpeg/libavfilter/vf_curves.c", 649); abort(); } } while (0);

    if (!f) {
        int ret = (-((*__error())));
        av_log(((void*)0), 16, "Cannot open file '%s' for writing: %s\n",
               fname, av_make_error_string((char[64]){0}, 64, ret));
        return ret;
    }

    av_bprint_init(&buf, 0, ((unsigned)-1));
...
static __attribute__((cold)) int curves_init(AVFilterContext *ctx)
{
    int i, ret;
    CurvesContext *curves = ctx->priv;
    ...
    if (curves->preset != PRESET_NONE) {
        ...
        do { if (!pts[0] && curves_presets[curves->preset].r) { pts[0] = av_strdup(curves_presets[curves->preset].r); if (!pts[0]) return (-(12)); } } while (0);
        do { if (!pts[1] && curves_presets[curves->preset].g) { pts[1] = av_strdup(curves_presets[curves->preset].g); if (!pts[1]) return (-(12)); } } while (0);
        do { if (!pts[2] && curves_presets[curves->preset].b) { pts[2] = av_strdup(curves_presets[curves->preset].b); if (!pts[2]) return (-(12)); } } while (0);
        do { if (!pts[3] && curves_presets[curves->preset].master) { pts[3] = av_strdup(curves_presets[curves->preset].master); if (!pts[3]) return (-(12)); } } while (0);
...
static int filter_slice_packed(AVFilterContext *ctx, void *arg, int jobnr, int nb_jobs)
{
    ...
    const uint8_t r = curves->rgba_map[0];
    const uint8_t g = curves->rgba_map[1];
    const uint8_t b = curves->rgba_map[2];
    const uint8_t a = curves->rgba_map[3];
    ...
    if (curves->is_16bit) {
        for (y = slice_start; y < slice_end; y++) {
            ...
            for (x = 0; x < in->width * step; x += step) {
                dstp[x + r] = curves->graph[0][srcp[x + r]];
                dstp[x + g] = curves->graph[1][srcp[x + g]];
                dstp[x + b] = curves->graph[2][srcp[x + b]];
                if (!direct && step == 4)
                    dstp[x + a] = srcp[x + a];
            }
        }
        ...
        for (y = slice_start; y < slice_end; y++) {
            for (x = 0; x < in->width * step; x += step) {
                dst[x + r] = curves->graph[0][src[x + r]];
                dst[x + g] = curves->graph[1][src[x + g]];
                dst[x + b] = curves->graph[2][src[x + b]];
                if (!direct && step == 4)
                    dst[x + a] = src[x + a];
            }
            dst += out->linesize[0];
    ...
    if (curves->is_16bit) {
        for (y = slice_start; y < slice_end; y++) {
            ...
            for (x = 0; x < in->width; x++) {
                dstrp[x] = curves->graph[0][srcrp[x]];
                dstgp[x] = curves->graph[1][srcgp[x]];
                dstbp[x] = curves->graph[2][srcbp[x]];
                if (!direct && step == 4)
                    dstap[x] = srcap[x];
            }
        }
        ...
        for (y = slice_start; y < slice_end; y++) {
            for (x = 0; x < in->width; x++) {
                dstr[x] = curves->graph[0][srcr[x]];
                dstg[x] = curves->graph[1][srcg[x]];
                dstb[x] = curves->graph[2][srcb[x]];
                if (!direct && step == 4)
                    dsta[x] = srca[x];
            }
            dstr += out->linesize[r];
...
static int config_input(AVFilterLink *inlink)
{
    ...
    char **pts = curves->comp_points_str;
    struct keypoint *comp_points[3 + 1] = {0};
    ...
    curves->filter_slice = desc->flags & (1 << 4) ? filter_slice_planar : filter_slice_packed;
    ...
    if (pts[3]) {
        for (i = 0; i < 3; i++)
            for (j = 0; j < curves->lut_size; j++)
                curves->graph[i][j] = curves->graph[3][curves->graph[i][j]];
    }

    if (av_log_get_level() >= 40) {
        for (i = 0; i < 3; i++) {
            const struct keypoint *point = comp_points[i];
            av_log(ctx, 40, "#%d points:", i);
            while (point) {
                av_log(ctx, 40, " (%f;%f)", point->x, point->y);
                point = point->next;
            }
        }
    }
...
static int filter_frame(AVFilterLink *inlink, AVFrame *in)
{
    ...
    td.in = in;
    td.out = out;
    ff_filter_execute(ctx, curves->filter_slice, &td, ((void*)0),
                           ...
                           char *res, int res_len, int flags)
{
    ...
    if (!strcmp(cmd, "plot")) {
        ...
        av_freep(&curves->comp_points_str[3]);
...
static __attribute__((cold)) void curves_uninit(AVFilterContext *ctx)
{
    int i;
    CurvesContext *curves = ctx->priv;
