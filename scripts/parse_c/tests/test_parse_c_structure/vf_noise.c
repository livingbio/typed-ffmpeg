# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.c" 2
# 27 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.c"
# 1 "./libavutil/emms.h" 1
# 22 "./libavutil/emms.h"
# 1 "./config.h" 1
# 23 "./libavutil/emms.h" 2
# 1 "./libavutil/attributes.h" 1
# 24 "./libavutil/emms.h" 2
# 28 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.c" 2
# 1 "./libavutil/opt.h" 1
# 30 "./libavutil/opt.h"
...
int av_opt_serialize(void *obj, int opt_flags, int flags, char **buffer,
                     const char key_val_sep, const char pairs_sep);
# 29 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.c" 2
...
# 30 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.c" 2
# 1 "./libavutil/lfg.h" 1
# 33 "./libavutil/lfg.h"
...
# 31 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.c" 2
...
# 32 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.c" 2
...
# 34 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.c" 2
...
# 35 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.c" 2
...
# 36 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.c" 2
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.h" 1
# 37 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.h"
...
# 37 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.c" 2
...
# 38 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.c" 2

typedef struct ThreadData {
    AVFrame *in, *out;
} ThreadData;
# 57 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_noise.c"
static const AVOption noise_options[] = {
    {"all""_seed", "set component #""0"" noise seed", __builtin_offsetof(NoiseContext, all.seed), AV_OPT_TYPE_INT, {.i64=-1}, -1, 2147483647, (1<<16)|16}, {"all""_strength", "set component #""0"" strength", __builtin_offsetof(NoiseContext, all.strength), AV_OPT_TYPE_INT, {.i64=0}, 0, 100, (1<<16)|16}, {"all""s", "set component #""0"" strength", __builtin_offsetof(NoiseContext, all.strength), AV_OPT_TYPE_INT, {.i64=0}, 0, 100, (1<<16)|16}, {"all""_flags", "set component #""0"" flags", __builtin_offsetof(NoiseContext, all.flags), AV_OPT_TYPE_FLAGS, {.i64=0}, 0, 31, (1<<16)|16, "all""_flags"}, {"all""f", "set component #""0"" flags", __builtin_offsetof(NoiseContext, all.flags), AV_OPT_TYPE_FLAGS, {.i64=0}, 0, 31, (1<<16)|16, "all""_flags"}, {"a", "averaged noise", 0, AV_OPT_TYPE_CONST, {.i64=8}, 0, 0, (1<<16)|16, "all""_flags"}, {"p", "(semi)regular pattern", 0, AV_OPT_TYPE_CONST, {.i64=16}, 0, 0, (1<<16)|16, "all""_flags"}, {"t", "temporal noise", 0, AV_OPT_TYPE_CONST, {.i64=2}, 0, 0, (1<<16)|16, "all""_flags"}, {"u", "uniform noise", 0, AV_OPT_TYPE_CONST, {.i64=1}, 0, 0, (1<<16)|16, "all""_flags"},
    {"c0""_seed", "set component #""0"" noise seed", __builtin_offsetof(NoiseContext, param[0].seed), AV_OPT_TYPE_INT, {.i64=-1}, -1, 2147483647, (1<<16)|16}, {"c0""_strength", "set component #""0"" strength", __builtin_offsetof(NoiseContext, param[0].strength), AV_OPT_TYPE_INT, {.i64=0}, 0, 100, (1<<16)|16}, {"c0""s", "set component #""0"" strength", __builtin_offsetof(NoiseContext, param[0].strength), AV_OPT_TYPE_INT, {.i64=0}, 0, 100, (1<<16)|16}, {"c0""_flags", "set component #""0"" flags", __builtin_offsetof(NoiseContext, param[0].flags), AV_OPT_TYPE_FLAGS, {.i64=0}, 0, 31, (1<<16)|16, "c0""_flags"}, {"c0""f", "set component #""0"" flags", __builtin_offsetof(NoiseContext, param[0].flags), AV_OPT_TYPE_FLAGS, {.i64=0}, 0, 31, (1<<16)|16, "c0""_flags"}, {"a", "averaged noise", 0, AV_OPT_TYPE_CONST, {.i64=8}, 0, 0, (1<<16)|16, "c0""_flags"}, {"p", "(semi)regular pattern", 0, AV_OPT_TYPE_CONST, {.i64=16}, 0, 0, (1<<16)|16, "c0""_flags"}, {"t", "temporal noise", 0, AV_OPT_TYPE_CONST, {.i64=2}, 0, 0, (1<<16)|16, "c0""_flags"}, {"u", "uniform noise", 0, AV_OPT_TYPE_CONST, {.i64=1}, 0, 0, (1<<16)|16, "c0""_flags"},
    {"c1""_seed", "set component #""1"" noise seed", __builtin_offsetof(NoiseContext, param[1].seed), AV_OPT_TYPE_INT, {.i64=-1}, -1, 2147483647, (1<<16)|16}, {"c1""_strength", "set component #""1"" strength", __builtin_offsetof(NoiseContext, param[1].strength), AV_OPT_TYPE_INT, {.i64=0}, 0, 100, (1<<16)|16}, {"c1""s", "set component #""1"" strength", __builtin_offsetof(NoiseContext, param[1].strength), AV_OPT_TYPE_INT, {.i64=0}, 0, 100, (1<<16)|16}, {"c1""_flags", "set component #""1"" flags", __builtin_offsetof(NoiseContext, param[1].flags), AV_OPT_TYPE_FLAGS, {.i64=0}, 0, 31, (1<<16)|16, "c1""_flags"}, {"c1""f", "set component #""1"" flags", __builtin_offsetof(NoiseContext, param[1].flags), AV_OPT_TYPE_FLAGS, {.i64=0}, 0, 31, (1<<16)|16, "c1""_flags"}, {"a", "averaged noise", 0, AV_OPT_TYPE_CONST, {.i64=8}, 0, 0, (1<<16)|16, "c1""_flags"}, {"p", "(semi)regular pattern", 0, AV_OPT_TYPE_CONST, {.i64=16}, 0, 0, (1<<16)|16, "c1""_flags"}, {"t", "temporal noise", 0, AV_OPT_TYPE_CONST, {.i64=2}, 0, 0, (1<<16)|16, "c1""_flags"}, {"u", "uniform noise", 0, AV_OPT_TYPE_CONST, {.i64=1}, 0, 0, (1<<16)|16, "c1""_flags"},
    {"c2""_seed", "set component #""2"" noise seed", __builtin_offsetof(NoiseContext, param[2].seed), AV_OPT_TYPE_INT, {.i64=-1}, -1, 2147483647, (1<<16)|16}, {"c2""_strength", "set component #""2"" strength", __builtin_offsetof(NoiseContext, param[2].strength), AV_OPT_TYPE_INT, {.i64=0}, 0, 100, (1<<16)|16}, {"c2""s", "set component #""2"" strength", __builtin_offsetof(NoiseContext, param[2].strength), AV_OPT_TYPE_INT, {.i64=0}, 0, 100, (1<<16)|16}, {"c2""_flags", "set component #""2"" flags", __builtin_offsetof(NoiseContext, param[2].flags), AV_OPT_TYPE_FLAGS, {.i64=0}, 0, 31, (1<<16)|16, "c2""_flags"}, {"c2""f", "set component #""2"" flags", __builtin_offsetof(NoiseContext, param[2].flags), AV_OPT_TYPE_FLAGS, {.i64=0}, 0, 31, (1<<16)|16, "c2""_flags"}, {"a", "averaged noise", 0, AV_OPT_TYPE_CONST, {.i64=8}, 0, 0, (1<<16)|16, "c2""_flags"}, {"p", "(semi)regular pattern", 0, AV_OPT_TYPE_CONST, {.i64=16}, 0, 0, (1<<16)|16, "c2""_flags"}, {"t", "temporal noise", 0, AV_OPT_TYPE_CONST, {.i64=2}, 0, 0, (1<<16)|16, "c2""_flags"}, {"u", "uniform noise", 0, AV_OPT_TYPE_CONST, {.i64=1}, 0, 0, (1<<16)|16, "c2""_flags"},
    {"c3""_seed", "set component #""3"" noise seed", __builtin_offsetof(NoiseContext, param[3].seed), AV_OPT_TYPE_INT, {.i64=-1}, -1, 2147483647, (1<<16)|16}, {"c3""_strength", "set component #""3"" strength", __builtin_offsetof(NoiseContext, param[3].strength), AV_OPT_TYPE_INT, {.i64=0}, 0, 100, (1<<16)|16}, {"c3""s", "set component #""3"" strength", __builtin_offsetof(NoiseContext, param[3].strength), AV_OPT_TYPE_INT, {.i64=0}, 0, 100, (1<<16)|16}, {"c3""_flags", "set component #""3"" flags", __builtin_offsetof(NoiseContext, param[3].flags), AV_OPT_TYPE_FLAGS, {.i64=0}, 0, 31, (1<<16)|16, "c3""_flags"}, {"c3""f", "set component #""3"" flags", __builtin_offsetof(NoiseContext, param[3].flags), AV_OPT_TYPE_FLAGS, {.i64=0}, 0, 31, (1<<16)|16, "c3""_flags"}, {"a", "averaged noise", 0, AV_OPT_TYPE_CONST, {.i64=8}, 0, 0, (1<<16)|16, "c3""_flags"}, {"p", "(semi)regular pattern", 0, AV_OPT_TYPE_CONST, {.i64=16}, 0, 0, (1<<16)|16, "c3""_flags"}, {"t", "temporal noise", 0, AV_OPT_TYPE_CONST, {.i64=2}, 0, 0, (1<<16)|16, "c3""_flags"}, {"u", "uniform noise", 0, AV_OPT_TYPE_CONST, {.i64=1}, 0, 0, (1<<16)|16, "c3""_flags"},
    {((void*)0)}
};

static const AVClass noise_class = { .class_name = "noise", .item_name = av_default_item_name, .option = noise_options, .version = ((58)<<16 | (36)<<8 | (100)), .category = AV_CLASS_CATEGORY_FILTER, };
...
const AVFilter ff_vf_noise = {
    ...
    .init = init,
    .uninit = uninit,
    .inputs = (noise_inputs), .nb_inputs = (sizeof((noise_inputs)) / sizeof(((noise_inputs))[0])),
