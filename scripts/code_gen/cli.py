...
def generate(outpath: pathlib.Path = pathlib.Path("./src/ffmpeg")) -> None:
    ...
    for f in filters:
        ...
        ffmpeg_filter = update_or_create(
            ...
            ref=doc.url,
            is_input_dynamic=help_info.is_dynamic_inputs if help_info else f.is_dynamic_inputs,
            is_output_dynamic=help_info.is_dynamic_outputs if help_info else f.is_dynamic_outputs,
            is_support_timeline=help_info.is_support_timeline if help_info else f.is_support_timeline,
