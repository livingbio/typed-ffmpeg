...
def audiotoolbox(
    ...
    Args:
        list_devices: list available audio devices (default false)
        audio_device_index: select audio device by index (starts at 0) (from -1 to INT_MAX) (default -1)
...
def hls(
    ...
    Args:
        ...
        hls_ts_options: set hls mpegts list of options for the container format used for hls (deprecated, use hls_segment_options instead of it.)
