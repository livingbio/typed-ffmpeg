...
Args:
    ...
    similarity: set the chromahold similarity value (from 0.01 to 1) (default 0.01)
...
Args:
    ...
    sizew: set horizontal size (from 1 to 100) (default 5)
    sizeh: set vertical size (from 1 to 100) (default 5)
...
Args:
    ...
    similarity: set the colorhold similarity value (from 0.01 to 1) (default 0.01)
...
References:
    ...
    *,
    list_filters: Boolean = Default('false'),list_generators: Boolean = Default('false'),filter: String = Default(None),output_rect: String = Default(None),
...
Args:
    ...
    radius: set radius (from 1 to 8192) (default 5)
    planes: set planes to filter (from 0 to 15) (default 15)
    timeline_options: Timeline options
    extra_options: Extra options for the filter
...
Args:
    ...
    ssim: use feature='name=ssim'. (default false)
    ms_ssim: use feature='name=ms_ssim'. (default false)
...
References:
    ...
    *,
    datapath: String = Default(None),language: String = Default('eng'),whitelist: String = Default('0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ.:;,-+_!?"\'[]{}()<>|/\\=*&%$#@!~ '),blacklist: String = Default(''),
...
Args:
    max_colors: set the maximum number of colors to use in the palette (from 4 to 256) (default 256)
    ...
    use_alpha: create a palette including alpha values (default false)
    extra_options: Extra options for the filter
...
Args:
    dither: select dithering mode (from 0 to 5) (default sierra2_4a)
...
Args:
    ...
    preset: set preset (from -1 to 13) (default none)
...
Args:
    ...
    win_func: set window function (from 0 to 19) (default rect)
