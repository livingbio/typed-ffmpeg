...
dct: int | None| Literal["auto", "fastint", "int", "mmx", "altivec", "faan"] = None,
...
colorspace: int | None| Literal["rgb", "bt709", "unknown", "fcc", "bt470bg", "smpte170m", "smpte240m", "ycgco", "bt2020nc", "bt2020c", "smpte2085", "chroma-derived-nc", "chroma-derived-c", "ictcp", "unspecified", "ycocg", "bt2020_ncl", "bt2020_cl"] = None,
color_range: int | None| Literal["unknown", "tv", "pc", "unspecified", "mpeg", "jpeg"] = None,
...
skip_loop_filter: int | None| Literal["none", "default", "noref", "bidir", "nokey", "nointra", "all"] = None,
skip_idct: int | None| Literal["none", "default", "noref", "bidir", "nokey", "nointra", "all"] = None,
skip_frame: int | None| Literal["none", "default", "noref", "bidir", "nokey", "nointra", "all"] = None,
ch_layout: str | None = None,
channel_layout: str | None = None,
...
sub_text_format: int | None| Literal["ass"] = None,
...
discard_damaged_percentage: int | None = None,
    ...
    """
        ...
        Args:
            ...
            sub_text_format: Deprecated, does nothing (from 0 to 1) (default ass),
    ...
    return FFMpegAVCodecContextDecoderOption(merge({
        ...
        "sub_text_format": sub_text_format,
