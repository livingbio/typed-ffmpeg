...
def libsvtav1(
    ...
    Args:
        hielevel: Hierarchical prediction levels setting (Deprecated, use svtav1-params) (from 3 to 4) (default 4level)
        la_depth: Look ahead distance [0, 120] (Deprecated, use svtav1-params) (from -1 to 120) (default -1)
        tier: Set operating point tier (Deprecated, use svtav1-params) (from 0 to 1) (default main)
        preset: Encoding preset (from -1 to 13) (default -1)
        crf: Constant Rate Factor value (from 0 to 63) (default 0)
        qp: Initial Quantizer level value (from 0 to 63) (default 0)
        sc_detection: Scene change detection (Deprecated, use svtav1-params) (default false)
        tile_columns: Log2 of number of tile columns to use (Deprecated, use svtav1-params) (from 0 to 4) (default 0)
        tile_rows: Log2 of number of tile rows to use (Deprecated, use svtav1-params) (from 0 to 6) (default 0)
...
def h264_videotoolbox(
    ...
    profile: int | None| Literal["baseline", "main", "high", "extended"] = None,
    ...
    Args:
        profile: Profile (from 0 to 5) (default 0)
...
def hevc_videotoolbox(
    ...
    profile: int | None| Literal["main", "main10"] = None,
    ...
    Args:
        profile: Profile (from 0 to 3) (default 0)
