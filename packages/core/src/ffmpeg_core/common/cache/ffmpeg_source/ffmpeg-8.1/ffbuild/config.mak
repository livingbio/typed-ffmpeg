...
CC_IDENT=Apple clang version 17.0.0 (clang-1700.6.4.2)
ARCH=aarch64
INTRINSICS=neon
EXTERN_PREFIX=_
CC=gcc
...
EXTRALIBS-avfilter=-framework OpenGL -framework OpenGL -pthread -lm -lz -framework VideoToolbox -framework CoreImage -framework AppKit -framework CoreFoundation -framework CoreMedia -framework CoreVideo -framework CoreServices
