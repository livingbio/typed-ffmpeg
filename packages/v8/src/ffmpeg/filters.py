...
Args:
    inputs: set number of input files to cross fade (from 1 to INT_MAX) (default 2)
...
Args:
    ...
    layout_mode: method used to determine the output channel layout (from 0 to 2) (default legacy)
    extra_options: Extra options for the filter
