...
Args:
    ...
    alpha_mode: select alpha mode (from 0 to 2) (default unspecified)
    extra_options: Extra options for the filter
...
def coreimagesrc(
    ...
    *,
    size: Image_size = Default('320x240'),rate: Video_rate = Default('25'),duration: Duration = Default('-0.000001'),sar: Rational = Default('1/1'),list_filters: Boolean = Default('false'),list_generators: Boolean = Default('false'),filter: String = Default(None),output_rect: String = Default(None),
...
References:
    [FFmpeg Documentation](https://ffmpeg.org/ffmpeg-filters.html#coreimagesrc)

    """
    filter_node = filter_node_factory(
        FFMpegFilterDef(name='coreimagesrc', typings_input=(), typings_output=('video',)),
