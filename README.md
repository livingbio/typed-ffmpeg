...
This tool converts XSD (XML Schema Definition) files to Python dataclasses. It's specifically designed to work with FFprobe's XSD schema but can be adapted for other XSD files.
...
Run the script with the XSD file as an argument:
...
- Supports optional fields and lists
- Converts camelCase/PascalCase to snake_case for Python conventions
- Generates proper type hints
- Handles XSD namespaces

## Example Output

The generated dataclasses will look something like this:
...
- The generator handles basic XSD types and converts them to appropriate Python types
- Complex types are converted to dataclasses
- Lists are handled using Python's typing.List
- Optional fields are handled using Python's typing.Optional
- The generated code includes proper type hints for better IDE support
