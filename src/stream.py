...
class Stream:
    ...
    def xmedian(self, *, inputs: int = None, planes: int = None, percentile: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="xmedian", kwargs={"inputs": inputs, "planes": planes, "percentile": percentile, **kwargs}).stream()
    ...
    def erosion(self, *, threshold0: int = None, threshold1: int = None, threshold2: int = None, threshold3: int = None, coordinates: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="erosion", kwargs={"threshold0": threshold0, "threshold1": threshold1, "threshold2": threshold2, "threshold3": threshold3, "coordinates": coordinates, **kwargs}).stream()
    ...
    def selectivecolor(self, *, correction_method: str = None, reds: str, yellows: str, greens: str, cyans: str, blues: str, magentas: str, whites: str, neutrals: str, blacks: str, psfile: str, **kwargs: dict[str, Any]) -> "Stream":
        """
    ...
    def loop(self, *, loop: int, size: int, start: int, time: float, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="loop", kwargs={"loop": loop, "size": size, "start": start, "time": time, **kwargs}).stream()

    def apsyclip(self, *, level_in: float = None, level_out: float = None, clip: float = None, diff: bool = None, adaptive: float = None, iterations: int = None, level: bool = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="apsyclip", kwargs={"level_in": level_in, "level_out": level_out, "clip": clip, "diff": diff, "adaptive": adaptive, "iterations": iterations, "level": level, **kwargs}).stream()
    ...
    def colorcorrect(self, *, rl: float = None, bl: float = None, rh: float = None, bh: float = None, saturation: float = None, analyze: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="colorcorrect", kwargs={"rl": rl, "bl": bl, "rh": rh, "bh": bh, "saturation": saturation, "analyze": analyze, **kwargs}).stream()
    ...
    def fps(self, *, fps: str = None, start_time: float = None, round: str = None, eof_action: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="fps", kwargs={"fps": fps, "start_time": start_time, "round": round, "eof_action": eof_action, **kwargs}).stream()

    def pullup(self, *, jl: int = None, jr: int = None, jt: int = None, jb: int = None, sb: int = None, mp: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="pullup", kwargs={"jl": jl, "jr": jr, "jt": jt, "jb": jb, "sb": sb, "mp": mp, **kwargs}).stream()

    def atrim(self, *, start: str, end: str, start_pts: str, end_pts: str, duration: str, start_sample: int, end_sample: int, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="atrim", kwargs={"start": start, "end": end, "start_pts": start_pts, "end_pts": end_pts, "duration": duration, "start_sample": start_sample, "end_sample": end_sample, **kwargs}).stream()

    def subtitles(self, *, filename: str, original_size: str, fontsdir: str, alpha: bool, charenc: str, stream_index: int, force_style: str, wrap_unicode: bool, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        return FilterNode(
            *[self],
            name="subtitles",
            kwargs={"filename": filename, "original_size": original_size, "fontsdir": fontsdir, "alpha": alpha, "charenc": charenc, "stream_index": stream_index, "force_style": force_style, "wrap_unicode": wrap_unicode, **kwargs}
        ).stream()
    ...
    def adeclick(self, *, window: int = None, overlap: int = None, arorder: int = None, threshold: int = None, burst: int = None, method: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="adeclick", kwargs={"window": window, "overlap": overlap, "arorder": arorder, "threshold": threshold, "burst": burst, "method": method, **kwargs}).stream()
    ...
    def pixscope(self, *, x: float, y: float, w: float, h: float, o: float, wx: float, wy: float, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="pixscope", kwargs={"x": x, "y": y, "w": w, "h": h, "o": o, "wx": wx, "wy": wy, **kwargs}).stream()

    def ocr(self, *, datapath: str, language: str, whitelist: str, blacklist: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="ocr", kwargs={"datapath": datapath, "language": language, "whitelist": whitelist, "blacklist": blacklist, **kwargs}).stream()

    def yadif_cuda(self, *, mode: str = None, parity: str = None, deint: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="yadif_cuda", kwargs={"mode": mode, "parity": parity, "deint": deint, **kwargs}).stream()

    def acrossover(self, *, split: list[str], order: str = None, level: float = None, gains: list[str] = None, precision: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="acrossover", kwargs={"split": split, "order": order, "level": level, "gains": gains, "precision": precision, **kwargs}).stream()
    ...
    def fftdnoiz(self, *, sigma: float = None, amount: float = None, block: int = None, overlap: float = None, method: str = None, prev: int = None, next: int = None, planes: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="fftdnoiz", kwargs={"sigma": sigma, "amount": amount, "block": block, "overlap": overlap, "method": method, "prev": prev, "next": next, "planes": planes, **kwargs}).stream()

    def limitdiff(self, *, threshold: float, elasticity: float, reference: bool, planes: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="limitdiff", kwargs={"threshold": threshold, "elasticity": elasticity, "reference": reference, "planes": planes, **kwargs}).stream()

    def deshake(
        self, *, x: int = None, y: int = None, w: int = None, h: int = None, rx: int = None, ry: int = None, edge: str = None, blocksize: int = None, contrast: int = None, search: str = None, filename: str, **kwargs: dict[str, Any]
    ) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="deshake", kwargs={"x": x, "y": y, "w": w, "h": h, "rx": rx, "ry": ry, "edge": edge, "blocksize": blocksize, "contrast": contrast, "search": search, "filename": filename, **kwargs}).stream()
    ...
    def dedot(self, *, m: str, lt: float, tl: float, tc: float, ct: float, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="dedot", kwargs={"m": m, "lt": lt, "tl": tl, "tc": tc, "ct": ct, **kwargs}).stream()

    def deblock(self, *, filter: str = None, block: int = None, alpha: float = None, beta: float = None, gamma: float = None, delta: float = None, planes: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="deblock", kwargs={"filter": filter, "block": block, "alpha": alpha, "beta": beta, "gamma": gamma, "delta": delta, "planes": planes, **kwargs}).stream()

    def tiltshelf(
        self, *, gain: float, frequency: float, width_type: str, width: float, poles: int = None, mix: float = None, channels: str, normalize: bool = None, transform: str, precision: str, block_size: int, **kwargs: dict[str, Any]
    ) -> "Stream":
        """
    ...
    def colormap(self, *, patch_size: str, nb_patches: int, type: str = None, kernel: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="colormap", kwargs={"patch_size": patch_size, "nb_patches": nb_patches, "type": type, "kernel": kernel, **kwargs}).stream()
    ...
    def headphone(self, *, map: str, gain: float, type: str, lfe: float, size: float = None, hrir: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="headphone", kwargs={"map": map, "gain": gain, "type": type, "lfe": lfe, "size": size, "hrir": hrir, **kwargs}).stream()
    ...
    def yadif(self, *, mode: str = None, parity: str = None, deint: str = None, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="yadif", kwargs={"mode": mode, "parity": parity, "deint": deint, **kwargs}).stream()

    def asubcut(self, *, cutoff: float = None, order: int = None, level: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="asubcut", kwargs={"cutoff": cutoff, "order": order, "level": level, **kwargs}).stream()
    ...
    def maskedclamp(self, *, undershoot: float = None, overshoot: float = None, planes: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="maskedclamp", kwargs={"undershoot": undershoot, "overshoot": overshoot, "planes": planes, **kwargs}).stream()

    def volume(self, *, volume: str = None, precision: str = None, replaygain: str = None, replaygain_preamp: float = None, replaygain_noclip: int = None, eval: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="volume", kwargs={"volume": volume, "precision": precision, "replaygain": replaygain, "replaygain_preamp": replaygain_preamp, "replaygain_noclip": replaygain_noclip, "eval": eval, **kwargs}).stream()
    ...
    def asetnsamples(self, *, nb_out_samples: int, pad: int, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="asetnsamples", kwargs={"nb_out_samples": nb_out_samples, "pad": pad, **kwargs}).stream()

    def curves(self, *, preset: str = None, master: str, red: str, green: str, blue: str, all: str, psfile: str, plot: str, interp: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="curves", kwargs={"preset": preset, "master": master, "red": red, "green": green, "blue": blue, "all": all, "psfile": psfile, "plot": plot, "interp": interp, **kwargs}).stream()
    ...
    def bitplanenoise(self, *, bitplane: int = None, filter: bool = None, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="bitplanenoise", kwargs={"bitplane": bitplane, "filter": filter, **kwargs}).stream()
    ...
    def median(self, *, radius: int = None, planes: int = None, radiusV: int = None, percentile: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="median", kwargs={"radius": radius, "planes": planes, "radiusV": radiusV, "percentile": percentile, **kwargs}).stream()
    ...
    def adeclip(self, *, window: int = None, overlap: int = None, arorder: int = None, threshold: int = None, hsize: int = None, method: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="adeclip", kwargs={"window": window, "overlap": overlap, "arorder": arorder, "threshold": threshold, "hsize": hsize, "method": method, **kwargs}).stream()

    def fspp(self, *, quality: int = None, qp: int, strength: int = None, use_bframe_qp: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="fspp", kwargs={"quality": quality, "qp": qp, "strength": strength, "use_bframe_qp": use_bframe_qp, **kwargs}).stream()
    ...
    def pad(self, *, width: str = None, height: str = None, x: str = None, y: str = None, color: str = None, eval: str = None, aspect: bool, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="pad", kwargs={"width": width, "height": height, "x": x, "y": y, "color": color, "eval": eval, "aspect": aspect, **kwargs}).stream()
    ...
    def astats(self, *, length: float = None, metadata: str, reset: bool = None, measure_perchannel: str = None, measure_overall: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="astats", kwargs={"length": length, "metadata": metadata, "reset": reset, "measure_perchannel": measure_perchannel, "measure_overall": measure_overall, **kwargs}).stream()
    ...
    def lut2(self, *, c0: str, c1: str, c2: str, c3: str, d: int, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="lut2", kwargs={"c0": c0, "c1": c1, "c2": c2, "c3": c3, "d": d, **kwargs}).stream()

    def fillborders(self, *, left: int, right: int, top: int, bottom: int, mode: str = None, color: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="fillborders", kwargs={"left": left, "right": right, "top": top, "bottom": bottom, "mode": mode, "color": color, **kwargs}).stream()

    def scroll(self, *, horizontal: float = None, vertical: float = None, hpos: float = None, vpos: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="scroll", kwargs={"horizontal": horizontal, "vertical": vertical, "hpos": hpos, "vpos": vpos, **kwargs}).stream()
    ...
    def normalize(self, *, blackpt: str, whitept: str, smoothing: int, independence: float, strength: float, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="normalize", kwargs={"blackpt": blackpt, "whitept": whitept, "smoothing": smoothing, "independence": independence, "strength": strength, **kwargs}).stream()

    def floodfill(self, *, x: int, y: int, s0: float, s1: float, s2: float, s3: float, d0: float, d1: float, d2: float, d3: float, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="floodfill", kwargs={"x": x, "y": y, "s0": s0, "s1": s1, "s2": s2, "s3": s3, "d0": d0, "d1": d1, "d2": d2, "d3": d3, **kwargs}).stream()
    ...
    def eq(
        ...
        **kwargs: dict[str, Any]
        ...
        return FilterNode(
            *[self],
            name="eq",
            kwargs={"contrast": contrast, "brightness": brightness, "saturation": saturation, "gamma": gamma, "gamma_r": gamma_r, "gamma_g": gamma_g, "gamma_b": gamma_b, "gamma_weight": gamma_weight, "eval": eval, **kwargs}
        ).stream()

    def edgedetect(self, *, low: str = None, high: str = None, mode: Literal["wires", "colormix", "canny"] = None, planes: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="edgedetect", kwargs={"low": low, "high": high, "mode": mode, "planes": planes, **kwargs}).stream()
    ...
    def xfade(self, *, transition: str = None, duration: float = None, offset: float = None, expr: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="xfade", kwargs={"transition": transition, "duration": duration, "offset": offset, "expr": expr, **kwargs}).stream()
    ...
    def asuperstop(self, *, centerf: float = None, order: int = None, qfactor: float = None, level: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="asuperstop", kwargs={"centerf": centerf, "order": order, "qfactor": qfactor, "level": level, **kwargs}).stream()
    ...
    def acrossfade(
        ...
        *,
        ...
        duration: str,
        overlap: bool,
        curve1: Literal["tri", "qsin", "hsin", "esin", "log", "ipar", "qua", "cub", "squ", "cbr", "par", "exp", "iqsin", "ihsin", "dese", "desi", "losi", "sinc", "isinc", "quat", "quatr", "qsin2", "hsin2", "nofade"],
        curve2: Literal["tri", "qsin", "hsin", "esin", "log", "ipar", "qua", "cub", "squ", "cbr", "par", "exp", "iqsin", "ihsin", "dese", "desi", "losi", "sinc", "isinc", "quat", "quatr", "qsin2", "hsin2", "nofade"],
        **kwargs: dict[str, Any]
    ) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="acrossfade", kwargs={"nb_samples": nb_samples, "duration": duration, "overlap": overlap, "curve1": curve1, "curve2": curve2, **kwargs}).stream()
    ...
    def owdenoise(self, *, depth: int = None, luma_strength: float = None, chroma_strength: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="owdenoise", kwargs={"depth": depth, "luma_strength": luma_strength, "chroma_strength": chroma_strength, **kwargs}).stream()

    def palettegen(self, *, max_colors: int, reserve_transparent: bool, transparency_color: str, stats_mode: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="palettegen", kwargs={"max_colors": max_colors, "reserve_transparent": reserve_transparent, "transparency_color": transparency_color, "stats_mode": stats_mode, **kwargs}).stream()

    def minterpolate(self, *, fps: str, mi_mode: str, scd: str, scd_threshold: float, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="minterpolate", kwargs={"fps": fps, "mi_mode": mi_mode, "scd": scd, "scd_threshold": scd_threshold, **kwargs}).stream()
    ...
    def monochrome(self, *, cb: float = None, cr: float = None, size: float = None, high: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="monochrome", kwargs={"cb": cb, "cr": cr, "size": size, "high": high, **kwargs}).stream()

    def hsvkey(self, *, hue: float = None, sat: float = None, val: float = None, similarity: float = None, blend: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="hsvkey", kwargs={"hue": hue, "sat": sat, "val": val, "similarity": similarity, "blend": blend, **kwargs}).stream()
    ...
    def cropdetect(self, *, mode: str, limit: str = None, round: int = None, skip: int, reset_count: int = None, mv_threshold: int = None, low: str, high: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="cropdetect", kwargs={"mode": mode, "limit": limit, "round": round, "skip": skip, "reset_count": reset_count, "mv_threshold": mv_threshold, "low": low, "high": high, **kwargs}).stream()
    ...
    def deconvolve(self, *, planes: str = None, impulse: str = None, noise: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="deconvolve", kwargs={"planes": planes, "impulse": impulse, "noise": noise, **kwargs}).stream()
    ...
    def chromakey(self, *, color: str, similarity: float, blend: float, yuv: bool, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="chromakey", kwargs={"color": color, "similarity": similarity, "blend": blend, "yuv": yuv, **kwargs}).stream()

    def overlay(self, *, x: str = None, y: str = None, eof_action: str, eval: str = None, shortest: str, format: str = None, repeatlast: str, alpha: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="overlay", kwargs={"x": x, "y": y, "eof_action": eof_action, "eval": eval, "shortest": shortest, "format": format, "repeatlast": repeatlast, "alpha": alpha, **kwargs}).stream()
    ...
    def perspective(self, *, x0: str, y0: str, x1: str, y1: str, x2: str, y2: str, x3: str, y3: str, interpolation: str, sense: str, eval: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="perspective", kwargs={"x0": x0, "y0": y0, "x1": x1, "y1": y1, "x2": x2, "y2": y2, "x3": x3, "y3": y3, "interpolation": interpolation, "sense": sense, "eval": eval, **kwargs}).stream()

    def bass(
        self, *, gain: float, frequency: float = None, width_type: str, width: float, poles: int = None, mix: float = None, channels: str, normalize: bool = None, transform: str, precision: str, block_size: int, **kwargs: dict[str, Any]
    ) -> "Stream":
        """
    ...
    def unpremultiply(self, *, planes: int, inplace: bool, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="unpremultiply", kwargs={"planes": planes, "inplace": inplace, **kwargs}).stream()

    def scale_npp(self, *, format: str, interp_algo: str, force_original_aspect_ratio: str, force_divisible_by: int, eval: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(
            *[self], name="scale_npp", kwargs={"format": format, "interp_algo": interp_algo, "force_original_aspect_ratio": force_original_aspect_ratio, "force_divisible_by": force_divisible_by, "eval": eval, **kwargs}
        ).stream()

    def yaepblur(self, *, radius: int = None, planes: str = None, sigma: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="yaepblur", kwargs={"radius": radius, "planes": planes, "sigma": sigma, **kwargs}).stream()

    def afreqshift(self, *, shift: float = None, level: float = None, order: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="afreqshift", kwargs={"shift": shift, "level": level, "order": order, **kwargs}).stream()

    def datascope(self, *, size: str, x: int, y: int, mode: str, axis: bool, opacity: float, format: str, components: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="datascope", kwargs={"size": size, "x": x, "y": y, "mode": mode, "axis": axis, "opacity": opacity, "format": format, "components": components, **kwargs}).stream()

    def tmix(self, *, frames: int = None, weights: str, scale: float, planes: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="tmix", kwargs={"frames": frames, "weights": weights, "scale": scale, "planes": planes, **kwargs}).stream()

    def amix(self, *, inputs: int = None, duration: str = None, dropout_transition: float = None, weights: str, normalize: bool = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="amix", kwargs={"inputs": inputs, "duration": duration, "dropout_transition": dropout_transition, "weights": weights, "normalize": normalize, **kwargs}).stream()

    def overlay_cuda(self, *, x: str = None, y: str = None, eval: str = None, eof_action: str, shortest: str, repeatlast: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="overlay_cuda", kwargs={"x": x, "y": y, "eval": eval, "eof_action": eof_action, "shortest": shortest, "repeatlast": repeatlast, **kwargs}).stream()

    def crop(self, *, w: str, h: str, x: str, y: str, keep_aspect: int, exact: int, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="crop", kwargs={"w": w, "h": h, "x": x, "y": y, "keep_aspect": keep_aspect, "exact": exact, **kwargs}).stream()
        ...
        **kwargs: dict[str, Any]
        ...
        return FilterNode(
            *[self],
            ...
            kwargs={"rr": rr, "rg": rg, "rb": rb, "ra": ra, "gr": gr, "gg": gg, "gb": gb, "ga": ga, "br": br, "bg": bg, "bb": bb, "ba": ba, "ar": ar, "ag": ag, "ab": ab, "aa": aa, "pc": pc, "pa": pa, **kwargs}
        ).stream()
    ...
    def avgblur(self, *, sizeX: int, planes: str, sizeY: int, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="avgblur", kwargs={"sizeX": sizeX, "planes": planes, "sizeY": sizeY, **kwargs}).stream()
    ...
    def framerate(self, *, fps: str = None, interp_start: int = None, interp_end: int = None, scene: float = None, flags: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="framerate", kwargs={"fps": fps, "interp_start": interp_start, "interp_end": interp_end, "scene": scene, "flags": flags, **kwargs}).stream()

    def photosensitivity(self, *, frames: int = None, threshold: float = None, skip: int = None, bypass: bool = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="photosensitivity", kwargs={"frames": frames, "threshold": threshold, "skip": skip, "bypass": bypass, **kwargs}).stream()
    ...
    def ashowinfo(self, *, n: int, pts: int, pts_time: float, fmt: str, chlayout: str, rate: int, nb_samples: int, checksum: str, plane_checksums: list[str], **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(
            *[self], name="ashowinfo", kwargs={"n": n, "pts": pts, "pts_time": pts_time, "fmt": fmt, "chlayout": chlayout, "rate": rate, "nb_samples": nb_samples, "checksum": checksum, "plane_checksums": plane_checksums, **kwargs}
        ).stream()

    def huesaturation(self, *, hue: float = None, saturation: float = None, intensity: float = None, colors: list[str], strength: float = None, rw: float = None, lightness: bool = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="huesaturation", kwargs={"hue": hue, "saturation": saturation, "intensity": intensity, "colors": colors, "strength": strength, "rw": rw, "lightness": lightness, **kwargs}).stream()

    def crossfeed(self, *, strength: float = None, range: float = None, slope: float = None, level_in: float = None, level_out: float = None, block_size: int, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="crossfeed", kwargs={"strength": strength, "range": range, "slope": slope, "level_in": level_in, "level_out": level_out, "block_size": block_size, **kwargs}).stream()

    def bilateral(self, *, sigmaS: float = None, sigmaR: float = None, planes: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="bilateral", kwargs={"sigmaS": sigmaS, "sigmaR": sigmaR, "planes": planes, **kwargs}).stream()

    def iccgen(self, *, color_primaries: str = None, color_trc: str = None, force: bool = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="iccgen", kwargs={"color_primaries": color_primaries, "color_trc": color_trc, "force": force, **kwargs}).stream()
    ...
    def mpdecimate(self, *, max: int = None, keep: int = None, hi: float = None, lo: float = None, frac: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="mpdecimate", kwargs={"max": max, "keep": keep, "hi": hi, "lo": lo, "frac": frac, **kwargs}).stream()
    ...
    def freezeframes(self, *, first: int, last: int, replace: int, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="freezeframes", kwargs={"first": first, "last": last, "replace": replace, **kwargs}).stream()
    ...
    def derain(self, *, filter_type: str = None, dnn_backend: str, model: str, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="derain", kwargs={"filter_type": filter_type, "dnn_backend": dnn_backend, "model": model, **kwargs}).stream()
    ...
    def aeval(self, *, exprs: str, channel_layout: str, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="aeval", kwargs={"exprs": exprs, "channel_layout": channel_layout, **kwargs}).stream()
    ...
    def channelsplit(self, *, channel_layout: str = None, channels: str = None, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="channelsplit", kwargs={"channel_layout": channel_layout, "channels": channels, **kwargs}).stream()
    ...
    def chorus(self, *, in_gain: float = None, out_gain: float = None, delays: list[str], decays: list[str], speeds: list[str], depths: list[str], **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="chorus", kwargs={"in_gain": in_gain, "out_gain": out_gain, "delays": delays, "decays": decays, "speeds": speeds, "depths": depths, **kwargs}).stream()

    def gblur(self, *, sigma: float = None, steps: int = None, planes: str, sigmaV: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="gblur", kwargs={"sigma": sigma, "steps": steps, "planes": planes, "sigmaV": sigmaV, **kwargs}).stream()

    def haldclut(self, *, clut: str = None, shortest: int = None, repeatlast: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="haldclut", kwargs={"clut": clut, "shortest": shortest, "repeatlast": repeatlast, **kwargs}).stream()

    def zoompan(self, *, zoom: float = None, x: float = None, y: float = None, d: float = None, s: str = None, fps: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="zoompan", kwargs={"zoom": zoom, "x": x, "y": y, "d": d, "s": s, "fps": fps, **kwargs}).stream()

    def equalizer(self, *, frequency: float, width_type: str, width: float, gain: float, mix: float, channels: str, normalize: bool, transform: str, precision: str, block_size: float, **kwargs: dict[str, Any]) -> "Stream":
        """
    ...
    def aspectralstats(self, *, win_size: int = None, win_func: str = None, overlap: float = None, measure: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="aspectralstats", kwargs={"win_size": win_size, "win_func": win_func, "overlap": overlap, "measure": measure, **kwargs}).stream()
    ...
    def swaprect(self, *, w: str, h: str, x1: str, y1: str, x2: str, y2: str, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="swaprect", kwargs={"w": w, "h": h, "x1": x1, "y1": y1, "x2": x2, "y2": y2, **kwargs}).stream()
    ...
    def lut(self, *, c0: str, c1: str, c2: str, c3: str, r: str, g: str, b: str, a: str, y: str, u: str, v: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="lut", kwargs={"c0": c0, "c1": c1, "c2": c2, "c3": c3, "r": r, "g": g, "b": b, "a": a, "y": y, "u": u, "v": v, **kwargs}).stream()

    def il(self, *, luma_mode: str = None, chroma_mode: str = None, alpha_mode: str = None, luma_swap: int = None, chroma_swap: int = None, alpha_swap: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="il", kwargs={"luma_mode": luma_mode, "chroma_mode": chroma_mode, "alpha_mode": alpha_mode, "luma_swap": luma_swap, "chroma_swap": chroma_swap, "alpha_swap": alpha_swap, **kwargs}).stream()

    def chromashift(self, *, cbh: float, cbv: float, crh: float, crv: float, edge: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="chromashift", kwargs={"cbh": cbh, "cbv": cbv, "crh": crh, "crv": crv, "edge": edge, **kwargs}).stream()
    ...
    def estdif(self, *, mode: str = None, parity: str = None, deint: str = None, rslope: int = None, redge: int = None, ecost: int = None, mcost: int = None, dcost: int = None, interp: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="estdif", kwargs={"mode": mode, "parity": parity, "deint": deint, "rslope": rslope, "redge": redge, "ecost": ecost, "mcost": mcost, "dcost": dcost, "interp": interp, **kwargs}).stream()
    ...
    def thistogram(
        self, *, width: int = None, display_mode: str = None, levels_mode: str = None, components: int = None, bgopacity: float = None, envelope: bool = None, ecolor: str = None, slide: str = None, **kwargs: dict[str, Any]
    ) -> "Stream":
        """
        ...
        """
        return FilterNode(
            *[self], name="thistogram", kwargs={"width": width, "display_mode": display_mode, "levels_mode": levels_mode, "components": components, "bgopacity": bgopacity, "envelope": envelope, "ecolor": ecolor, "slide": slide, **kwargs}
        ).stream()

    def scale_cuda(self, *, w: str, h: str, interp_algo: str, format: str, passthrough: int, param: str, force_original_aspect_ratio: bool, force_divisible_by: int, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        return FilterNode(
            *[self],
            name="scale_cuda",
            kwargs={"w": w, "h": h, "interp_algo": interp_algo, "format": format, "passthrough": passthrough, "param": param, "force_original_aspect_ratio": force_original_aspect_ratio, "force_divisible_by": force_divisible_by, **kwargs}
        ).stream()
    ...
    def varblur(self, *, min_r: int = None, max_r: int = None, planes: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="varblur", kwargs={"min_r": min_r, "max_r": max_r, "planes": planes, **kwargs}).stream()
    ...
    def cue(self, *, cue: int, preroll: float, buffer: float, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="cue", kwargs={"cue": cue, "preroll": preroll, "buffer": buffer, **kwargs}).stream()
    ...
    def morpho(self, *, mode: str = None, planes: str, structure: str = None, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="morpho", kwargs={"mode": mode, "planes": planes, "structure": structure, **kwargs}).stream()
    ...
    def dnn_detect(self, *, dnn_backend: str, model: str, input: str, output: str, confidence: float = None, labels: str, backend_configs: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="dnn_detect", kwargs={"dnn_backend": dnn_backend, "model": model, "input": input, "output": output, "confidence": confidence, "labels": labels, "backend_configs": backend_configs, **kwargs}).stream()

    def histeq(self, *, strength: float = None, intensity: float = None, antibanding: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="histeq", kwargs={"strength": strength, "intensity": intensity, "antibanding": antibanding, **kwargs}).stream()
    ...
    def mestimate(self, *, method: str = None, mb_size: int = None, search_param: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="mestimate", kwargs={"method": method, "mb_size": mb_size, "search_param": search_param, **kwargs}).stream()
    ...
    def detelecine(self, *, first_field: str = None, pattern: str = None, start_frame: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="detelecine", kwargs={"first_field": first_field, "pattern": pattern, "start_frame": start_frame, **kwargs}).stream()

    def adrc(self, *, transfer: str = None, attack: int = None, release: int = None, channels: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="adrc", kwargs={"transfer": transfer, "attack": attack, "release": release, "channels": channels, **kwargs}).stream()

    def blockdetect(self, *, period_min: list[str] = None, period_max: list[str] = None, planes: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="blockdetect", kwargs={"period_min": period_min, "period_max": period_max, "planes": planes, **kwargs}).stream()
    ...
    def spp(self, *, quality: int = None, qp: int, mode: str = None, use_bframe_qp: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="spp", kwargs={"quality": quality, "qp": qp, "mode": mode, "use_bframe_qp": use_bframe_qp, **kwargs}).stream()

    def chromanr(self, *, thres: int = None, sizew: int = None, sizeh: int = None, stepw: int = None, steph: int = None, threy: int = None, threu: int = None, threv: int = None, distance: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="chromanr", kwargs={"thres": thres, "sizew": sizew, "sizeh": sizeh, "stepw": stepw, "steph": steph, "threy": threy, "threu": threu, "threv": threv, "distance": distance, **kwargs}).stream()
    ...
    def kirsch(self, *, planes: int, scale: float, delta: float, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="kirsch", kwargs={"planes": planes, "scale": scale, "delta": delta, **kwargs}).stream()

    def addroi(self, *, x: str, y: str, w: str, h: str, qoffset: float, clear: bool, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="addroi", kwargs={"x": x, "y": y, "w": w, "h": h, "qoffset": qoffset, "clear": clear, **kwargs}).stream()
    ...
    def pseudocolor(self, *, c0: str, c1: str, c2: str, c3: str, index: str, preset: str, opacity: float, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="pseudocolor", kwargs={"c0": c0, "c1": c1, "c2": c2, "c3": c3, "index": index, "preset": preset, "opacity": opacity, **kwargs}).stream()
    ...
    def channelmap(self, *, map: str, channel_layout: str, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="channelmap", kwargs={"map": map, "channel_layout": channel_layout, **kwargs}).stream()

    def aexciter(self, *, level_in: float = None, level_out: float = None, amount: float = None, drive: float = None, blend: float = None, freq: float = None, ceil: float, listen: bool = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="aexciter", kwargs={"level_in": level_in, "level_out": level_out, "amount": amount, "drive": drive, "blend": blend, "freq": freq, "ceil": ceil, "listen": listen, **kwargs}).stream()
    ...
    def asuperpass(self, *, centerf: float = None, order: int = None, qfactor: float = None, level: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="asuperpass", kwargs={"centerf": centerf, "order": order, "qfactor": qfactor, "level": level, **kwargs}).stream()

    def deesser(self, *, i: float = None, m: float = None, f: float = None, s: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
    ...
    def flanger(self, *, delay: float = None, depth: float = None, regen: float = None, width: float = None, speed: float = None, shape: str = None, phase: float = None, interp: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="flanger", kwargs={"delay": delay, "depth": depth, "regen": regen, "width": width, "speed": speed, "shape": shape, "phase": phase, "interp": interp, **kwargs}).stream()
    ...
    def sobel(self, *, planes: int, scale: float, delta: float, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="sobel", kwargs={"planes": planes, "scale": scale, "delta": delta, **kwargs}).stream()

    def colorize(self, *, hue: float = None, saturation: float = None, lightness: float = None, mix: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="colorize", kwargs={"hue": hue, "saturation": saturation, "lightness": lightness, "mix": mix, **kwargs}).stream()
    ...
    def negate(self, *, components: str, negate_alpha: int = None, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="negate", kwargs={"components": components, "negate_alpha": negate_alpha, **kwargs}).stream()
    ...
    def hwmap(self, *, mode: str, derive_device: str, reverse: bool, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="hwmap", kwargs={"mode": mode, "derive_device": derive_device, "reverse": reverse, **kwargs}).stream()
    ...
    def roberts(self, *, planes: int, scale: float, delta: float, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="roberts", kwargs={"planes": planes, "scale": scale, "delta": delta, **kwargs}).stream()
    ...
    def replaygain(self, *, track_gain: float, track_peak: float, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="replaygain", kwargs={"track_gain": track_gain, "track_peak": track_peak, **kwargs}).stream()

    def drawgrid(self, *, x: str, y: str, width: str, height: str, color: str, thickness: str, replace: int, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="drawgrid", kwargs={"x": x, "y": y, "width": width, "height": height, "color": color, "thickness": thickness, "replace": replace, **kwargs}).stream()

    def rotate(self, *, angle: str, out_w: str, out_h: str, bilinear: int, fillcolor: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="rotate", kwargs={"angle": angle, "out_w": out_w, "out_h": out_h, "bilinear": bilinear, "fillcolor": fillcolor, **kwargs}).stream()
    ...
    def dcshift(self, *, shift: float, limitergain: float, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="dcshift", kwargs={"shift": shift, "limitergain": limitergain, **kwargs}).stream()
    ...
    def coreimage(self, *, list_filters: bool, filter: str, output_rect: str, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="coreimage", kwargs={"list_filters": list_filters, "filter": filter, "output_rect": output_rect, **kwargs}).stream()
    ...
    def anlmdn(self, *, strength: float = None, patch: int = None, research: int = None, output: str = None, smooth: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="anlmdn", kwargs={"strength": strength, "patch": patch, "research": research, "output": output, "smooth": smooth, **kwargs}).stream()

    def shear(self, *, shx: float = None, shy: float = None, fillcolor: str = None, interp: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="shear", kwargs={"shx": shx, "shy": shy, "fillcolor": fillcolor, "interp": interp, **kwargs}).stream()
    ...
    def scale_vt(self, *, w: str, h: str, color_matrix: str, color_primaries: str, color_transfer: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="scale_vt", kwargs={"w": w, "h": h, "color_matrix": color_matrix, "color_primaries": color_primaries, "color_transfer": color_transfer, **kwargs}).stream()
    ...
    def freezedetect(self, *, noise: str, duration: str, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="freezedetect", kwargs={"noise": noise, "duration": duration, **kwargs}).stream()
    ...
    def sr(self, *, dnn_backend: str, model: str, scale_factor: int = None, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="sr", kwargs={"dnn_backend": dnn_backend, "model": model, "scale_factor": scale_factor, **kwargs}).stream()

    def afade(self, *, type: str = None, start_sample: int = None, nb_samples: int = None, start_time: str = None, duration: str, curve: str = None, silence: float = None, unity: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(
            *[self], name="afade", kwargs={"type": type, "start_sample": start_sample, "nb_samples": nb_samples, "start_time": start_time, "duration": duration, "curve": curve, "silence": silence, "unity": unity, **kwargs}
        ).stream()

    def despill(self, *, type: str, mix: str, expand: float, red: float, green: float, blue: float, brightness: float, alpha: bool, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="despill", kwargs={"type": type, "mix": mix, "expand": expand, "red": red, "green": green, "blue": blue, "brightness": brightness, "alpha": alpha, **kwargs}).stream()
    ...
    def trim(self, *, start: str, end: str, start_pts: str, end_pts: str, duration: str, start_frame: int, end_frame: int, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="trim", kwargs={"start": start, "end": end, "start_pts": start_pts, "end_pts": end_pts, "duration": duration, "start_frame": start_frame, "end_frame": end_frame, **kwargs}).stream()

    def alimiter(
        self, *, level_in: float = None, level_out: float = None, limit: float = None, attack: float = None, release: float = None, asc: bool, asc_level: float, level: bool = None, latency: bool, **kwargs: dict[str, Any]
    ) -> "Stream":
        """
        ...
        """
        return FilterNode(
            *[self], name="alimiter", kwargs={"level_in": level_in, "level_out": level_out, "limit": limit, "attack": attack, "release": release, "asc": asc, "asc_level": asc_level, "level": level, "latency": latency, **kwargs}
        ).stream()
    ...
    def tlut2(self, *, c0: str, c1: str, c2: str, c3: str, d: int, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="tlut2", kwargs={"c0": c0, "c1": c1, "c2": c2, "c3": c3, "d": d, **kwargs}).stream()

    def dnn_processing(self, *, dnn_backend: str, model: str, input: str, output: str, backend_configs: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="dnn_processing", kwargs={"dnn_backend": dnn_backend, "model": model, "input": input, "output": output, "backend_configs": backend_configs, **kwargs}).stream()
    ...
    def setparams(self, *, field_mode: str = None, range: str = None, color_primaries: str = None, color_trc: str = None, colorspace: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="setparams", kwargs={"field_mode": field_mode, "range": range, "color_primaries": color_primaries, "color_trc": color_trc, "colorspace": colorspace, **kwargs}).stream()
    ...
    def kerndeint(self, *, thresh: int = None, map: int = None, order: int = None, sharp: int = None, twoway: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="kerndeint", kwargs={"thresh": thresh, "map": map, "order": order, "sharp": sharp, "twoway": twoway, **kwargs}).stream()
    ...
    def hysteresis(self, *, planes: int, threshold: int, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="hysteresis", kwargs={"planes": planes, "threshold": threshold, **kwargs}).stream()

    def w3fdif(self, *, filter: str = None, mode: str = None, parity: str = None, deint: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="w3fdif", kwargs={"filter": filter, "mode": mode, "parity": parity, "deint": deint, **kwargs}).stream()
    ...
    def ladspa(self, *, file: str, plugin: str, controls: str, sample_rate: int = None, nb_samples: int = None, duration: str, latency: bool = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="ladspa", kwargs={"file": file, "plugin": plugin, "controls": controls, "sample_rate": sample_rate, "nb_samples": nb_samples, "duration": duration, "latency": latency, **kwargs}).stream()
    ...
    def blackframe(self, *, amount: int = None, threshold: int = None, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="blackframe", kwargs={"amount": amount, "threshold": threshold, **kwargs}).stream()
    ...
    def backgroundkey(self, *, threshold: float, similarity: float, blend: float, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="backgroundkey", kwargs={"threshold": threshold, "similarity": similarity, "blend": blend, **kwargs}).stream()

    def acrusher(self, *, level_in: float, level_out: float, bits: int, mix: float, mode: str, dc: float, aa: float, samples: int, lfo: bool, lforange: float, lforate: float, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(
            *[self], name="acrusher", kwargs={"level_in": level_in, "level_out": level_out, "bits": bits, "mix": mix, "mode": mode, "dc": dc, "aa": aa, "samples": samples, "lfo": lfo, "lforange": lforange, "lforate": lforate, **kwargs}
        ).stream()
    ...
    def adynamicsmooth(self, *, sensitivity: float = None, basefreq: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="adynamicsmooth", kwargs={"sensitivity": sensitivity, "basefreq": basefreq, **kwargs}).stream()
    ...
    def atadenoise(
        ...
        **kwargs: dict[str, Any]
        ...
        """
        return FilterNode(*[self], name="atadenoise", kwargs={"0a": _0a, "0b": _0b, "1a": _1a, "1b": _1b, "2a": _2a, "2b": _2b, "s": s, "p": p, "a": a, "0s": _0s, "1s": _1s, "2s": _2s, **kwargs}).stream()

    def readvitc(self, *, scan_max: int = None, thr_b: float = None, thr_w: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="readvitc", kwargs={"scan_max": scan_max, "thr_b": thr_b, "thr_w": thr_w, **kwargs}).stream()

    def aloop(self, *, loop: int = None, size: int = None, start: int = None, time: float, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="aloop", kwargs={"loop": loop, "size": size, "start": start, "time": time, **kwargs}).stream()

    def aformat(self, *, sample_fmts: str, sample_rates: str, channel_layouts: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="aformat", kwargs={"sample_fmts": sample_fmts, "sample_rates": sample_rates, "channel_layouts": channel_layouts, **kwargs}).stream()

    def vignette(self, *, angle: str = None, x0: str = None, y0: str = None, mode: str = None, eval: str = None, dither: int = None, aspect: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="vignette", kwargs={"angle": angle, "x0": x0, "y0": y0, "mode": mode, "eval": eval, "dither": dither, "aspect": aspect, **kwargs}).stream()

    def compensationdelay(self, *, mm: int = None, cm: int = None, m: int = None, dry: float = None, wet: float = None, temp: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="compensationdelay", kwargs={"mm": mm, "cm": cm, "m": m, "dry": dry, "wet": wet, "temp": temp, **kwargs}).stream()
    ...
    def lv2(self, *, plugin: str, controls: str, sample_rate: int = None, nb_samples: int = None, duration: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="lv2", kwargs={"plugin": plugin, "controls": controls, "sample_rate": sample_rate, "nb_samples": nb_samples, "duration": duration, **kwargs}).stream()
    ...
    def drawbox(self, *, x: str, y: str, width: str, height: str, color: str, thickness: str, replace: int, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="drawbox", kwargs={"x": x, "y": y, "width": width, "height": height, "color": color, "thickness": thickness, "replace": replace, **kwargs}).stream()

    def asubboost(
        self, *, dry: float = None, wet: float = None, boost: float = None, decay: float = None, feedback: float = None, cutoff: float = None, slope: float = None, delay: float = None, channels: str = None, **kwargs: dict[str, Any]
    ) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="asubboost", kwargs={"dry": dry, "wet": wet, "boost": boost, "decay": decay, "feedback": feedback, "cutoff": cutoff, "slope": slope, "delay": delay, "channels": channels, **kwargs}).stream()
    ...
    def shuffleplanes(self, *, map0: int, map1: int, map2: int, map3: int, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="shuffleplanes", kwargs={"map0": map0, "map1": map1, "map2": map2, "map3": map3, **kwargs}).stream()
    ...
    def ocv(self, *, filter_name: str, filter_params: str, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="ocv", kwargs={"filter_name": filter_name, "filter_params": filter_params, **kwargs}).stream()

    def graphmonitor(self, *, size: str = None, opacity: float = None, mode: str = None, flags: str = None, rate: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="graphmonitor", kwargs={"size": size, "opacity": opacity, "mode": mode, "flags": flags, "rate": rate, **kwargs}).stream()

    def rgbashift(self, *, rh: float, rv: float, gh: float, gv: float, bh: float, bv: float, ah: float, av: float, edge: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="rgbashift", kwargs={"rh": rh, "rv": rv, "gh": gh, "gv": gv, "bh": bh, "bv": bv, "ah": ah, "av": av, "edge": edge, **kwargs}).stream()
    ...
    def bs2b(self, *, profile: str, fcut: float, feed: float, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="bs2b", kwargs={"profile": profile, "fcut": fcut, "feed": feed, **kwargs}).stream()
    ...
    def colorhold(self, *, color: str, similarity: float, blend: float, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="colorhold", kwargs={"color": color, "similarity": similarity, "blend": blend, **kwargs}).stream()
    ...
    def asupercut(self, *, cutoff: int = None, order: int = None, level: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="asupercut", kwargs={"cutoff": cutoff, "order": order, "level": level, **kwargs}).stream()
    ...
    def drawgraph(
        self, *, m1: str, fg1: str, m2: str, fg2: str, m3: str, fg3: str, m4: str, fg4: str, min: float, max: float, bg: str, mode: str = None, slide: str = None, size: str, rate: float = None, **kwargs: dict[str, Any]
    ) -> "Stream":
        """
        ...
        """
        return FilterNode(
            *[self], name="drawgraph", kwargs={"m1": m1, "fg1": fg1, "m2": m2, "fg2": fg2, "m3": m3, "fg3": fg3, "m4": m4, "fg4": fg4, "min": min, "max": max, "bg": bg, "mode": mode, "slide": slide, "size": size, "rate": rate, **kwargs}
        ).stream()
    ...
    def colorcontrast(self, *, rc: float = None, gm: float = None, by: float = None, rcw: float = None, gmw: float = None, byw: float = None, pl: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="colorcontrast", kwargs={"rc": rc, "gm": gm, "by": by, "rcw": rcw, "gmw": gmw, "byw": byw, "pl": pl, **kwargs}).stream()

    def chromahold(self, *, color: str, similarity: float, blend: float, yuv: bool, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="chromahold", kwargs={"color": color, "similarity": similarity, "blend": blend, "yuv": yuv, **kwargs}).stream()

    def arls(self, *, order: int, _lambda: float, delta: float, out_mode: str = None, precision: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="arls", kwargs={"order": order, "lambda": _lambda, "delta": delta, "out_mode": out_mode, "precision": precision, **kwargs}).stream()
    ...
    def deband(self, *, _1thr: float = None, _2thr: float = None, _3thr: float = None, _4thr: float = None, range: int = None, direction: float = None, blur: bool = None, coupling: bool = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="deband", kwargs={"1thr": _1thr, "2thr": _2thr, "3thr": _3thr, "4thr": _4thr, "range": range, "direction": direction, "blur": blur, "coupling": coupling, **kwargs}).stream()
    ...
    def blurdetect(self, *, low: str, high: str, radius: int, block_pct: int, block_width: int, block_height: int, planes: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="blurdetect", kwargs={"low": low, "high": high, "radius": radius, "block_pct": block_pct, "block_width": block_width, "block_height": block_height, "planes": planes, **kwargs}).stream()
    ...
    def bilateral_cuda(self, *, sigmaS: float = None, sigmaR: float = None, window_size: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="bilateral_cuda", kwargs={"sigmaS": sigmaS, "sigmaR": sigmaR, "window_size": window_size, **kwargs}).stream()

    def nlmeans(self, *, s: float = None, p: int = None, pc: int = None, r: int = None, rc: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="nlmeans", kwargs={"s": s, "p": p, "pc": pc, "r": r, "rc": rc, **kwargs}).stream()
    ...
    def mix(self, *, inputs: int = None, weights: str, scale: float, planes: int = None, duration: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="mix", kwargs={"inputs": inputs, "weights": weights, "scale": scale, "planes": planes, "duration": duration, **kwargs}).stream()

    def removegrain(self, *, m0: int = None, m1: int = None, m2: int = None, m3: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="removegrain", kwargs={"m0": m0, "m1": m1, "m2": m2, "m3": m3, **kwargs}).stream()

    def aecho(self, *, in_gain: float = None, out_gain: float = None, delays: str = None, decays: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="aecho", kwargs={"in_gain": in_gain, "out_gain": out_gain, "delays": delays, "decays": decays, **kwargs}).stream()

    def xstack(self, *, inputs: int = None, layout: str, grid: str, shortest: int = None, fill: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="xstack", kwargs={"inputs": inputs, "layout": layout, "grid": grid, "shortest": shortest, "fill": fill, **kwargs}).stream()
    ...
    def maskedthreshold(self, *, threshold: float, planes: int, mode: str = None, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="maskedthreshold", kwargs={"threshold": threshold, "planes": planes, "mode": mode, **kwargs}).stream()

    def guided(self, *, radius: int = None, eps: float = None, mode: str = None, sub: int = None, guidance: str = None, planes: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="guided", kwargs={"radius": radius, "eps": eps, "mode": mode, "sub": sub, "guidance": guidance, "planes": planes, **kwargs}).stream()
    ...
    def acompressor(
        ...
        **kwargs: dict[str, Any]
        ...
        return FilterNode(
            *[self],
            name="acompressor",
            kwargs={"level_in": level_in, "mode": mode, "threshold": threshold, "ratio": ratio, "attack": attack, "release": release, "makeup": makeup, "knee": knee, "link": link, "detection": detection, "mix": mix, **kwargs}
        ).stream()
    ...
    def xcorrelate(self, *, planes: str, secondary: str = None, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="xcorrelate", kwargs={"planes": planes, "secondary": secondary, **kwargs}).stream()
    ...
    def anlmf(self, *, order: int, mu: float, eps: float, leakage: float, out_mode: str = None, precision: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="anlmf", kwargs={"order": order, "mu": mu, "eps": eps, "leakage": leakage, "out_mode": out_mode, "precision": precision, **kwargs}).stream()

    def afftfilt(self, *, real: str = None, imag: str = None, win_size: int = None, win_func: str = None, overlap: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="afftfilt", kwargs={"real": real, "imag": imag, "win_size": win_size, "win_func": win_func, "overlap": overlap, **kwargs}).stream()
    ...
    def pixelize(self, *, width: int = None, height: int = None, mode: str = None, planes: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="pixelize", kwargs={"width": width, "height": height, "mode": mode, "planes": planes, **kwargs}).stream()

    def paletteuse(self, *, dither: str = None, bayer_scale: int = None, diff_mode: str = None, new: bool, alpha_threshold: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="paletteuse", kwargs={"dither": dither, "bayer_scale": bayer_scale, "diff_mode": diff_mode, "new": new, "alpha_threshold": alpha_threshold, **kwargs}).stream()

    def lutyuv(self, *, c0: str, c1: str, c2: str, c3: str, r: str, g: str, b: str, a: str, y: str, u: str, v: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        11.153 lut, lutrgb, lutyuv Compute a look-up table for binding each pixel component input value to an output value, and apply it to the input video. lutyuv applies a lookup table to a YUV input video, lutrgb to an RGB input video. These filters accept the following parameters: Each of them specifies the expression to use for computing the lookup table for the corresponding pixel component values. The exact component associated to each of the c* options depends on the format in input. The lut filter requires either YUV or RGB pixel formats in input, lutrgb requires RGB pixel formats in input, and lutyuv requires YUV. The expressions can contain the following constants and functions: All expressions default to "clipval".
        ...
        """
        return FilterNode(*[self], name="lutyuv", kwargs={"c0": c0, "c1": c1, "c2": c2, "c3": c3, "r": r, "g": g, "b": b, "a": a, "y": y, "u": u, "v": v, **kwargs}).stream()

    def anlms(self, *, order: int, mu: float, eps: float, leakage: float, out_mode: str = None, precision: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        8.39 anlmf, anlms Apply Normalized Least-Mean-(Squares|Fourth) algorithm to the first audio stream using the second audio stream. This adaptive filter is used to mimic a desired filter by finding the filter coefficients that relate to producing the least mean square of the error signal (difference between the desired, 2nd input audio stream and the actual signal, the 1st input audio stream). A description of the accepted options follows.
        ...
        """
        return FilterNode(*[self], name="anlms", kwargs={"order": order, "mu": mu, "eps": eps, "leakage": leakage, "out_mode": out_mode, "precision": precision, **kwargs}).stream()
    ...
    def maskfun(self, *, low: float, high: float, planes: str, fill: float, sum: float, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="maskfun", kwargs={"low": low, "high": high, "planes": planes, "fill": fill, "sum": sum, **kwargs}).stream()

    def colortemperature(self, *, temperature: int = None, mix: float = None, pl: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="colortemperature", kwargs={"temperature": temperature, "mix": mix, "pl": pl, **kwargs}).stream()
    ...
    def bwdif(self, *, mode: str = None, parity: str = None, deint: str = None, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="bwdif", kwargs={"mode": mode, "parity": parity, "deint": deint, **kwargs}).stream()
    ...
    def dilation(self, *, threshold0: int = None, threshold1: int = None, threshold2: int = None, threshold3: int = None, coordinates: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="dilation", kwargs={"threshold0": threshold0, "threshold1": threshold1, "threshold2": threshold2, "threshold3": threshold3, "coordinates": coordinates, **kwargs}).stream()
    ...
    def scharr(self, *, planes: int, scale: float, delta: float, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="scharr", kwargs={"planes": planes, "scale": scale, "delta": delta, **kwargs}).stream()

    def geq(self, *, lum_expr: str, cb_expr: str, cr_expr: str, alpha_expr: str, red_expr: str, green_expr: str, blue_expr: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="geq", kwargs={"lum_expr": lum_expr, "cb_expr": cb_expr, "cr_expr": cr_expr, "alpha_expr": alpha_expr, "red_expr": red_expr, "green_expr": green_expr, "blue_expr": blue_expr, **kwargs}).stream()

    def tmedian(self, *, radius: int = None, planes: int = None, percentile: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="tmedian", kwargs={"radius": radius, "planes": planes, "percentile": percentile, **kwargs}).stream()
    ...
    def virtualbass(self, *, cutoff: float = None, strength: float = None, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="virtualbass", kwargs={"cutoff": cutoff, "strength": strength, **kwargs}).stream()

    def asr(self, *, rate: int = None, hmm: str, dict: str, lm: str, lmctl: str, lmname: str, logfn: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="asr", kwargs={"rate": rate, "hmm": hmm, "dict": dict, "lm": lm, "lmctl": lmctl, "lmname": lmname, "logfn": logfn, **kwargs}).stream()
    ...
    def speechnorm(
        ...
        **kwargs: dict[str, Any]
        ...
        return FilterNode(
            *[self],
            name="speechnorm",
            kwargs={"peak": peak, "expansion": expansion, "compression": compression, "threshold": threshold, "raise": _raise, "fall": fall, "channels": channels, "invert": invert, "link": link, "rms": rms, **kwargs}
        ).stream()
    ...
    def uspp(self, *, quality: int = None, qp: int, codec: str, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="uspp", kwargs={"quality": quality, "qp": qp, "codec": codec, **kwargs}).stream()

    def vaguedenoiser(self, *, threshold: float = None, method: str = None, nsteps: int = None, percent: int = None, planes: list[str], type: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="vaguedenoiser", kwargs={"threshold": threshold, "method": method, "nsteps": nsteps, "percent": percent, "planes": planes, "type": type, **kwargs}).stream()
    ...
    def asoftclip(self, *, type: str, threshold: float = None, output: float = None, param: float, oversample: float, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="asoftclip", kwargs={"type": type, "threshold": threshold, "output": output, "param": param, "oversample": oversample, **kwargs}).stream()

    def colorbalance(
        self, *, rs: float = None, gs: float = None, bs: float = None, rm: float = None, gm: float = None, bm: float = None, rh: float = None, gh: float = None, bh: float = None, pl: bool = None, **kwargs: dict[str, Any]
    ) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="colorbalance", kwargs={"rs": rs, "gs": gs, "bs": bs, "rm": rm, "gm": gm, "bm": bm, "rh": rh, "gh": gh, "bh": bh, "pl": pl, **kwargs}).stream()
    ...
    def aphaser(self, *, in_gain: float = None, out_gain: float = None, delay: float = None, decay: float = None, speed: float = None, type: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="aphaser", kwargs={"in_gain": in_gain, "out_gain": out_gain, "delay": delay, "decay": decay, "speed": speed, "type": type, **kwargs}).stream()

    def compand(self, *, attacks: list[str], decays: list[str], points: list[str], soft_knee: float, gain: float, volume: float, delay: float, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="compand", kwargs={"attacks": attacks, "decays": decays, "points": points, "soft-knee": soft_knee, "gain": gain, "volume": volume, "delay": delay, **kwargs}).stream()
    ...
    def transpose_npp(self, *, dir: str = None, passthrough: str = None, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="transpose_npp", kwargs={"dir": dir, "passthrough": passthrough, **kwargs}).stream()

    def tpad(self, *, start: int = None, stop: int = None, start_mode: str = None, stop_mode: str = None, start_duration: str = None, color: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="tpad", kwargs={"start": start, "stop": stop, "start_mode": start_mode, "stop_mode": stop_mode, "start_duration": start_duration, "color": color, **kwargs}).stream()
    ...
    def agate(
        ...
        **kwargs: dict[str, Any]
        ...
        return FilterNode(
            *[self],
            name="agate",
            kwargs={"level_in": level_in, "mode": mode, "range": range, "threshold": threshold, "ratio": ratio, "attack": attack, "release": release, "makeup": makeup, "knee": knee, "detection": detection, "link": link, **kwargs}
        ).stream()
    ...
    def colorkey(self, *, color: str = None, similarity: float = None, blend: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="colorkey", kwargs={"color": color, "similarity": similarity, "blend": blend, **kwargs}).stream()
    ...
    def tile(self, *, layout: str, nb_frames: int, margin: int, padding: int, color: str, overlap: int, init_padding: int, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="tile", kwargs={"layout": layout, "nb_frames": nb_frames, "margin": margin, "padding": padding, "color": color, "overlap": overlap, "init_padding": init_padding, **kwargs}).stream()

    def stereowiden(self, *, delay: float = None, feedback: float = None, crossfeed: float = None, drymix: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="stereowiden", kwargs={"delay": delay, "feedback": feedback, "crossfeed": crossfeed, "drymix": drymix, **kwargs}).stream()
    ...
    def apulsator(
        ...
        **kwargs: dict[str, Any]
        ...
        return FilterNode(
            *[self],
            name="apulsator",
            kwargs={"level_in": level_in, "level_out": level_out, "mode": mode, "amount": amount, "offset_l": offset_l, "offset_r": offset_r, "width": width, "timing": timing, "bpm": bpm, "ms": ms, "hz": hz, **kwargs}
        ).stream()

    def deflicker(self, *, size: int = None, mode: str = None, bypass: bool = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="deflicker", kwargs={"size": size, "mode": mode, "bypass": bypass, **kwargs}).stream()

    def bm3d(
        self, *, sigma: float = None, block: str, bstep: int = None, group: int = None, range: int, mstep: int = None, thmse: int, hdthr: float, estim: str = None, ref: bool = None, planes: str = None, **kwargs: dict[str, Any]
    ) -> "Stream":
        """
        ...
        """
        return FilterNode(
            *[self], name="bm3d", kwargs={"sigma": sigma, "block": block, "bstep": bstep, "group": group, "range": range, "mstep": mstep, "thmse": thmse, "hdthr": hdthr, "estim": estim, "ref": ref, "planes": planes, **kwargs}
        ).stream()

    def apad(self, *, packet_size: int = None, pad_len: int, whole_len: int, pad_dur: str, whole_dur: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="apad", kwargs={"packet_size": packet_size, "pad_len": pad_len, "whole_len": whole_len, "pad_dur": pad_dur, "whole_dur": whole_dur, **kwargs}).stream()
    ...
    def afwtdn(self, *, sigma: float = None, levels: int = None, wavet: str, percent: int = None, profile: bool = None, adaptive: bool = None, samples: int = None, softness: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="afwtdn", kwargs={"sigma": sigma, "levels": levels, "wavet": wavet, "percent": percent, "profile": profile, "adaptive": adaptive, "samples": samples, "softness": softness, **kwargs}).stream()
    ...
    def bwdif_cuda(self, *, mode: str = None, parity: str = None, deint: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="bwdif_cuda", kwargs={"mode": mode, "parity": parity, "deint": deint, **kwargs}).stream()
    ...
    def hdcd(self, *, disable_autoconvert: bool, process_stereo: bool, cdt_ms: int, force_pe: bool, analyze_mode: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="hdcd", kwargs={"disable_autoconvert": disable_autoconvert, "process_stereo": process_stereo, "cdt_ms": cdt_ms, "force_pe": force_pe, "analyze_mode": analyze_mode, **kwargs}).stream()

    def aphaseshift(self, *, shift: float = None, level: float = None, order: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="aphaseshift", kwargs={"shift": shift, "level": level, "order": order, **kwargs}).stream()
    ...
    def delogo(self, *, x: int, y: int, w: int, h: int, show: int, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="delogo", kwargs={"x": x, "y": y, "w": w, "h": h, "show": show, **kwargs}).stream()

    def amplify(self, *, radius: int = None, factor: int = None, threshold: int = None, tolerance: int = None, low: int = None, high: int = None, planes: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="amplify", kwargs={"radius": radius, "factor": factor, "threshold": threshold, "tolerance": tolerance, "low": low, "high": high, "planes": planes, **kwargs}).stream()

    def anequalizer(self, *, params: str, curves: bool, size: str, mgain: float, fscale: str, colors: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="anequalizer", kwargs={"params": params, "curves": curves, "size": size, "mgain": mgain, "fscale": fscale, "colors": colors, **kwargs}).stream()
    ...
    def dialoguenhance(self, *, original: float = None, enhance: float = None, voice: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="dialoguenhance", kwargs={"original": original, "enhance": enhance, "voice": voice, **kwargs}).stream()
    ...
    def bandpass(
        self, *, frequency: float = None, csg: int = None, width_type: str, width: float, mix: float = None, channels: str, normalize: bool = None, transform: str, precision: str, block_size: int, **kwargs: dict[str, Any]
    ) -> "Stream":
        """
        ...
        return FilterNode(
            *[self],
            name="bandpass",
            kwargs={"frequency": frequency, "csg": csg, "width_type": width_type, "width": width, "mix": mix, "channels": channels, "normalize": normalize, "transform": transform, "precision": precision, "block_size": block_size, **kwargs}
        ).stream()

    def lutrgb(self, *, c0: str, c1: str, c2: str, c3: str, r: str, g: str, b: str, a: str, y: str, u: str, v: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        11.153 lut, lutrgb, lutyuv Compute a look-up table for binding each pixel component input value to an output value, and apply it to the input video. lutyuv applies a lookup table to a YUV input video, lutrgb to an RGB input video. These filters accept the following parameters: Each of them specifies the expression to use for computing the lookup table for the corresponding pixel component values. The exact component associated to each of the c* options depends on the format in input. The lut filter requires either YUV or RGB pixel formats in input, lutrgb requires RGB pixel formats in input, and lutyuv requires YUV. The expressions can contain the following constants and functions: All expressions default to "clipval".
        ...
        """
        return FilterNode(*[self], name="lutrgb", kwargs={"c0": c0, "c1": c1, "c2": c2, "c3": c3, "r": r, "g": g, "b": b, "a": a, "y": y, "u": u, "v": v, **kwargs}).stream()
    ...
    def frei0r(self, *, filter_name: str, filter_params: str, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="frei0r", kwargs={"filter_name": filter_name, "filter_params": filter_params, **kwargs}).stream()

    def blackdetect(self, *, black_min_duration: float = None, picture_black_ratio_th: float = None, pixel_black_th: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="blackdetect", kwargs={"black_min_duration": black_min_duration, "picture_black_ratio_th": picture_black_ratio_th, "pixel_black_th": pixel_black_th, **kwargs}).stream()

    def oscilloscope(self, *, x: float, y: float, s: float, t: float, o: float, tx: float, ty: float, tw: float, th: float, c: str, g: bool, st: bool, sc: bool, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="oscilloscope", kwargs={"x": x, "y": y, "s": s, "t": t, "o": o, "tx": tx, "ty": ty, "tw": tw, "th": th, "c": c, "g": g, "st": st, "sc": sc, **kwargs}).stream()

    def deflate(self, *, threshold0: int = None, threshold1: int = None, threshold2: int = None, threshold3: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="deflate", kwargs={"threshold0": threshold0, "threshold1": threshold1, "threshold2": threshold2, "threshold3": threshold3, **kwargs}).stream()
    ...
    def mergeplanes(
        self, *, mapping: str = None, format: str = None, map0s: int = None, map1s: int = None, map2s: int = None, map3s: int = None, map0p: int = None, map1p: int = None, map2p: int = None, map3p: int = None, **kwargs: dict[str, Any]
    ) -> "Stream":
        """
        ...
        """
        return FilterNode(
            *[self], name="mergeplanes", kwargs={"mapping": mapping, "format": format, "map0s": map0s, "map1s": map1s, "map2s": map2s, "map3s": map3s, "map0p": map0p, "map1p": map1p, "map2p": map2p, "map3p": map3p, **kwargs}
        ).stream()
    ...
    def elbg(self, *, codebook_length: int = None, nb_steps: int = None, seed: int = None, pal8: bool = None, use_alpha: bool = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="elbg", kwargs={"codebook_length": codebook_length, "nb_steps": nb_steps, "seed": seed, "pal8": pal8, "use_alpha": use_alpha, **kwargs}).stream()
    ...
    def codecview(self, *, block: bool, mv: str, qp: bool, mv_type: str, frame_type: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="codecview", kwargs={"block": block, "mv": mv, "qp": qp, "mv_type": mv_type, "frame_type": frame_type, **kwargs}).stream()
    ...
    def telecine(self, *, first_field: str = None, pattern: str = None, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="telecine", kwargs={"first_field": first_field, "pattern": pattern, **kwargs}).stream()

    def hsvhold(self, *, hue: float = None, sat: float = None, val: float = None, similarity: float = None, blend: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="hsvhold", kwargs={"hue": hue, "sat": sat, "val": val, "similarity": similarity, "blend": blend, **kwargs}).stream()
    ...
    def atilt(self, *, freq: float = None, slope: float = None, width: float = None, order: str, level: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="atilt", kwargs={"freq": freq, "slope": slope, "width": width, "order": order, "level": level, **kwargs}).stream()

    def libvmaf(self, *, model: str = None, feature: str, log_path: str, log_fmt: str, pool: str = None, n_threads: int = None, n_subsample: int, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="libvmaf", kwargs={"model": model, "feature": feature, "log_path": log_path, "log_fmt": log_fmt, "pool": pool, "n_threads": n_threads, "n_subsample": n_subsample, **kwargs}).stream()

    def sab(self, *, luma_radius: float = None, luma_pre_filter_radius: float = None, luma_strength: float = None, chroma_radius: float, chroma_pre_filter_radius: float, chroma_strength: float, **kwargs: dict[str, Any]) -> "Stream":
        """
    ...
    def ciescope(self, *, system: str, cie: str, gamuts: str, size: int, intensity: float, contrast: float, corrgamma: bool, showwhite: bool, gamma: float, fill: bool, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        return FilterNode(
            *[self],
            name="ciescope",
            kwargs={"system": system, "cie": cie, "gamuts": gamuts, "size": size, "intensity": intensity, "contrast": contrast, "corrgamma": corrgamma, "showwhite": showwhite, "gamma": gamma, "fill": fill, **kwargs}
        ).stream()

    def decimate(self, *, cycle: int = None, dupthresh: float = None, scthresh: int = None, blockx: int = None, blocky: int = None, ppsrc: int = None, chroma: int = None, mixed: bool = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="decimate", kwargs={"cycle": cycle, "dupthresh": dupthresh, "scthresh": scthresh, "blockx": blockx, "blocky": blocky, "ppsrc": ppsrc, "chroma": chroma, "mixed": mixed, **kwargs}).stream()

    def allpass(self, *, frequency: float, width_type: str, width: float, mix: float = None, channels: str, normalize: bool = None, order: int = None, transform: str, precision: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        return FilterNode(
            *[self],
            name="allpass",
            kwargs={"frequency": frequency, "width_type": width_type, "width": width, "mix": mix, "channels": channels, "normalize": normalize, "order": order, "transform": transform, "precision": precision, **kwargs}
        ).stream()
    ...
    def tmidequalizer(self, *, radius: int = None, sigma: float = None, planes: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="tmidequalizer", kwargs={"radius": radius, "sigma": sigma, "planes": planes, **kwargs}).stream()

    def vidstabdetect(
        self, *, result: str = None, shakiness: int = None, accuracy: int = None, stepsize: int = None, mincontrast: float = None, tripod: int = None, show: int = None, fileformat: str = None, **kwargs: dict[str, Any]
    ) -> "Stream":
        """
        ...
        """
        return FilterNode(
            *[self], name="vidstabdetect", kwargs={"result": result, "shakiness": shakiness, "accuracy": accuracy, "stepsize": stepsize, "mincontrast": mincontrast, "tripod": tripod, "show": show, "fileformat": fileformat, **kwargs}
        ).stream()
    ...
    def dblur(self, *, angle: float = None, radius: float = None, planes: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="dblur", kwargs={"angle": angle, "radius": radius, "planes": planes, **kwargs}).stream()

    def nnedi(self, *, weights: str, deint: str = None, field: str, planes: str, nsize: str, nns: str, qual: str, etype: str, pscrn: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="nnedi", kwargs={"weights": weights, "deint": deint, "field": field, "planes": planes, "nsize": nsize, "nns": nns, "qual": qual, "etype": etype, "pscrn": pscrn, **kwargs}).stream()

    def dnn_classify(self, *, dnn_backend: str, model: str, input: str, output: str, confidence: float = None, labels: str, backend_configs: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(
            *[self], name="dnn_classify", kwargs={"dnn_backend": dnn_backend, "model": model, "input": input, "output": output, "confidence": confidence, "labels": labels, "backend_configs": backend_configs, **kwargs}
        ).stream()

    def greyedge(self, *, difford: float = None, minknorm: float = None, sigma: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="greyedge", kwargs={"difford": difford, "minknorm": minknorm, "sigma": sigma, **kwargs}).stream()
    ...
    def rubberband(self, *, tempo: float, pitch: float, transients: str, detector: str, phase: str, window: str, smoothing: str, formant: str, pitchq: str, channels: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        return FilterNode(
            *[self],
            name="rubberband",
            kwargs={"tempo": tempo, "pitch": pitch, "transients": transients, "detector": detector, "phase": phase, "window": window, "smoothing": smoothing, "formant": formant, "pitchq": pitchq, "channels": channels, **kwargs}
        ).stream()

    def signature(
        self, *, detectmode: str = None, nb_inputs: int = None, filename: str, format: str = None, th_d: int = None, th_dc: int = None, th_xh: int = None, th_di: int = None, th_it: float = None, **kwargs: dict[str, Any]
    ) -> "Stream":
        """
        ...
        """
        return FilterNode(
            *[self], name="signature", kwargs={"detectmode": detectmode, "nb_inputs": nb_inputs, "filename": filename, "format": format, "th_d": th_d, "th_dc": th_dc, "th_xh": th_xh, "th_di": th_di, "th_it": th_it, **kwargs}
        ).stream()

    def multiply(self, *, scale: float = None, offset: float = None, planes: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="multiply", kwargs={"scale": scale, "offset": offset, "planes": planes, **kwargs}).stream()

    def lumakey(self, *, threshold: float = None, tolerance: float = None, softness: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="lumakey", kwargs={"threshold": threshold, "tolerance": tolerance, "softness": softness, **kwargs}).stream()
    ...
    def psnr(self, *, stats_file: str, stats_version: int, stats_add_max: int, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="psnr", kwargs={"stats_file": stats_file, "stats_version": stats_version, "stats_add_max": stats_add_max, **kwargs}).stream()

    def vibrance(self, *, intensity: int = None, rbal: int = None, gbal: int = None, bbal: int = None, rlum: float, glum: float, blum: float, alternate: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="vibrance", kwargs={"intensity": intensity, "rbal": rbal, "gbal": gbal, "bbal": bbal, "rlum": rlum, "glum": glum, "blum": blum, "alternate": alternate, **kwargs}).stream()

    def aap(self, *, order: int, projection: int, mu: float, delta: float, out_mode: str = None, precision: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="aap", kwargs={"order": order, "projection": projection, "mu": mu, "delta": delta, "out_mode": out_mode, "precision": precision, **kwargs}).stream()
    ...
    def prewitt(self, *, planes: int, scale: float, delta: float, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="prewitt", kwargs={"planes": planes, "scale": scale, "delta": delta, **kwargs}).stream()

    def fade(self, *, type: str = None, start_frame: int = None, nb_frames: int = None, alpha: int = None, start_time: float = None, duration: float = None, color: str = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="fade", kwargs={"type": type, "start_frame": start_frame, "nb_frames": nb_frames, "alpha": alpha, "start_time": start_time, "duration": duration, "color": color, **kwargs}).stream()
    ...
    def lensfun(
        self, *, make: str, model: str, lens_model: str, db_path: str, mode: str, focal_length: float, aperture: float, focus_distance: float, scale: float, target_geometry: str, reverse: bool, interpolation: str, **kwargs: dict[str, Any]
    ) -> "Stream":
        """
    ...
    def hqdn3d(self, *, luma_spatial: float = None, chroma_spatial: float = None, luma_tmp: float = None, chroma_tmp: float = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="hqdn3d", kwargs={"luma_spatial": luma_spatial, "chroma_spatial": chroma_spatial, "luma_tmp": luma_tmp, "chroma_tmp": chroma_tmp, **kwargs}).stream()
    ...
    def silencedetect(self, *, noise: str, duration: str, mono: bool, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="silencedetect", kwargs={"noise": noise, "duration": duration, "mono": mono, **kwargs}).stream()
    ...
    def treble(self, *, gain: float, frequency: float, width_type: str, width: float, poles: int, mix: float, channels: str, normalize: bool, transform: str, precision: str, block_size: int, **kwargs: dict[str, Any]) -> "Stream":
        """
        8.116 treble, highshelf Boost or cut treble (upper) frequencies of the audio using a two-pole shelving filter with a response similar to that of a standard hi-fi’s tone-controls. This is also known as shelving equalisation (EQ). The filter accepts the following options:
    ...
    def bandreject(self, *, frequency: float = None, width_type: str, width: float, mix: float = None, channels: str, normalize: bool = None, transform: str, precision: str, block_size: float, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        return FilterNode(
            *[self],
            name="bandreject",
            kwargs={"frequency": frequency, "width_type": width_type, "width": width, "mix": mix, "channels": channels, "normalize": normalize, "transform": transform, "precision": precision, "block_size": block_size, **kwargs}
        ).stream()

    def aemphasis(self, *, level_in: float, level_out: float, mode: str = None, type: str, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="aemphasis", kwargs={"level_in": level_in, "level_out": level_out, "mode": mode, "type": type, **kwargs}).stream()
    ...
    def dctdnoiz(self, *, sigma: float = None, overlap: int, expr: str, n: int, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="dctdnoiz", kwargs={"sigma": sigma, "overlap": overlap, "expr": expr, "n": n, **kwargs}).stream()

    def inflate(self, *, threshold0: int = None, threshold1: int = None, threshold2: int = None, threshold3: int = None, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="inflate", kwargs={"threshold0": threshold0, "threshold1": threshold1, "threshold2": threshold2, "threshold3": threshold3, **kwargs}).stream()

    def shufflepixels(self, *, direction: str = None, mode: str, width: int, height: int, seed: int, **kwargs: dict[str, Any]) -> "Stream":
        """
        ...
        """
        return FilterNode(*[self], name="shufflepixels", kwargs={"direction": direction, "mode": mode, "width": width, "height": height, "seed": seed, **kwargs}).stream()
    ...
    def join(self, *, inputs: int = None, channel_layout: str = None, map: str, **kwargs: dict[str, Any]) -> "Stream":
        ...
        """
        return FilterNode(*[self], name="join", kwargs={"inputs": inputs, "channel_layout": channel_layout, "map": map, **kwargs}).stream()
