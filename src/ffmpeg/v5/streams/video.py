...
class VideoStream(FilterableStream):
    ...
    def paletteuse(
        ...
        *,
        dither: Int
        | Literal["bayer", "heckbert", "floyd_steinberg", "sierra2", "sierra2_4a"]
        ...
        color_search: Int
        | Literal["nns_iterative", "nns_recursive", "bruteforce"]
        | Default = Default("nns_iterative"),
