...
def decimate(
    ...
    **kwargs: Any
    ...
    N
    means one frame in every batch of
    N
    ...
    small movements. Must be a power of two. Default is
    32
    .
    - **`ppsrc`**
...
def guided(
    ...
    **kwargs: Any
    ...
    If
    off
    , single input is required.
    If
    on
    , two inputs of the same resolution and pixel format are required.
...
def headphone(
    ...
    **kwargs: Any
    ...
    If value is set to
    stereo
    , number of additional streams should
...
def join(
    ...
    **kwargs: Any
    ...
    form.
    input_idx
    is the 0-based index of the input stream.
    in_channel
    can be either the name of the input channel (e.g. FL for front left) or its
    index in the specified input stream.
    out_channel
...
def mergeplanes(
    ...
    **kwargs: Any
    ...
    - **`mapping`**
      - Set input to output plane mapping. Default is
    0
    .
...
def xstack(
    ...
    **kwargs: Any
    ...
    (equivalent to
    grid=2x1
    ) is set. In all other cases, a layout or a grid must be set by
    the user. Either
    grid
    or
    layout
    ...
    is set, then
    inputs
    option is ignored and is implicitly
    set to
    ROWS * COLUMNS
    .
    ...
    (equivalent to
    layout=0_0|w0_0
    ) is set. In all other cases, a layout or a grid must be
...
def xstack_qsv(
    ...
    **kwargs: Any
    ...
    .
    - **`grid_tile_size`**
      - Set output size for each input stream when
    grid
    is set. If this option
