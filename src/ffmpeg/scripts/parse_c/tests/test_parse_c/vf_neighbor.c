# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_neighbor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_neighbor.c" 2
# 22 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_neighbor.c"
# 1 "./config_components.h" 1
# 23 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_neighbor.c" 2
...
# 32 "./libavutil/imgutils.h" 2
# 1 "./libavutil/pixdesc.h" 1
# 25 "./libavutil/pixdesc.h"
...
# 25 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_neighbor.c" 2
...
# 26 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_neighbor.c" 2
...
int av_opt_serialize(void *obj, int opt_flags, int flags, char **buffer,
                     const char key_val_sep, const char pairs_sep);
# 28 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_neighbor.c" 2
...
# 29 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_neighbor.c" 2
...
# 30 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_neighbor.c" 2
...
# 31 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_neighbor.c" 2
...
static const enum AVPixelFormat pix_fmts[] = {
    ...
    AV_PIX_FMT_YUV420P9LE, AV_PIX_FMT_YUV422P9LE, AV_PIX_FMT_YUV444P9LE,
    AV_PIX_FMT_YUV420P10LE, AV_PIX_FMT_YUV422P10LE, AV_PIX_FMT_YUV444P10LE,
    AV_PIX_FMT_YUV420P12LE, AV_PIX_FMT_YUV422P12LE, AV_PIX_FMT_YUV444P12LE, AV_PIX_FMT_YUV440P12LE,
    ...
    AV_PIX_FMT_YUVA420P9LE, AV_PIX_FMT_YUVA422P9LE, AV_PIX_FMT_YUVA444P9LE,
    AV_PIX_FMT_YUVA420P10LE, AV_PIX_FMT_YUVA422P10LE, AV_PIX_FMT_YUVA444P10LE,
    AV_PIX_FMT_YUVA422P12LE, AV_PIX_FMT_YUVA444P12LE,
    AV_PIX_FMT_YUVA420P16LE, AV_PIX_FMT_YUVA422P16LE, AV_PIX_FMT_YUVA444P16LE,
    AV_PIX_FMT_GBRP, AV_PIX_FMT_GBRP9LE, AV_PIX_FMT_GBRP10LE,
    AV_PIX_FMT_GBRP12LE, AV_PIX_FMT_GBRP14LE, AV_PIX_FMT_GBRP16LE,
    AV_PIX_FMT_GBRAP, AV_PIX_FMT_GBRAP10LE, AV_PIX_FMT_GBRAP12LE, AV_PIX_FMT_GBRAP16LE,
    AV_PIX_FMT_GRAY8, AV_PIX_FMT_GRAY9LE, AV_PIX_FMT_GRAY10LE, AV_PIX_FMT_GRAY12LE, AV_PIX_FMT_GRAY14LE, AV_PIX_FMT_GRAY16LE,
    AV_PIX_FMT_NONE
};
                    ...
                    int maxc)
{
    ...
    for (x = 0; x < width; x++) {
        ...
        for (i = 0; i < 8; i++) {
            if (coord & (1 << i)) {
                min = ((min) > (*(coordinates[i] + x)) ? (*(coordinates[i] + x)) : (min));
            }
                     ...
                     int maxc)
{
    ...
    for (x = 0; x < width; x++) {
        int max = p1[x];
        int limit = ((max + threshold) > (255) ? (255) : (max + threshold));

        for (i = 0; i < 8; i++) {
            if (coord & (1 << i)) {
                max = ((max) > (*(coordinates[i] + x)) ? (max) : (*(coordinates[i] + x)));
            }
                    ...
                    int maxc)
{
    ...
    for (x = 0; x < width; x++) {
        int sum = 0;
        int limit = ((p1[x] - threshold) > (0) ? (p1[x] - threshold) : (0));

        for (i = 0; i < 8; sum += *(coordinates[i++] + x));

        dst[x] = ((((sum / 8) > (p1[x]) ? (p1[x]) : (sum / 8))) > (limit) ? (((sum / 8) > (p1[x]) ? (p1[x]) : (sum / 8))) : (limit));
    }
}
                      ...
                      int maxc)
{
    ...
    for (x = 0; x < width; x++) {
        int sum = 0;
        int limit = (((((const av_alias16*)(&p1[2 * x]))->u16) + threshold) > (maxc) ? (maxc) : ((((const av_alias16*)(&p1[2 * x]))->u16) + threshold));

        for (i = 0; i < 8; sum += (((const av_alias16*)(coordinates[i++] + x * 2))->u16));

        dst[x] = ((((sum / 8) > ((((const av_alias16*)(&p1[x * 2]))->u16)) ? (sum / 8) : ((((const av_alias16*)(&p1[x * 2]))->u16)))) > (limit) ? (limit) : (((sum / 8) > ((((const av_alias16*)(&p1[x * 2]))->u16)) ? (sum / 8) : ((((const av_alias16*)(&p1[x * 2]))->u16)))));
    }
}
...
static int config_input(AVFilterLink *inlink)
{
    ...
    s->planewidth[1] = s->planewidth[2] = (!__builtin_constant_p(desc->log2_chroma_w) ? -((-(inlink->w)) >> (desc->log2_chroma_w)) : ((inlink->w) + (1<<(desc->log2_chroma_w)) - 1) >> (desc->log2_chroma_w));
    s->planewidth[0] = s->planewidth[3] = inlink->w;
    s->planeheight[1] = s->planeheight[2] = (!__builtin_constant_p(desc->log2_chroma_h) ? -((-(inlink->h)) >> (desc->log2_chroma_h)) : ((inlink->h) + (1<<(desc->log2_chroma_h)) - 1) >> (desc->log2_chroma_h));
...
static int filter_frame(AVFilterLink *inlink, AVFrame *in)
{
    ...
    ff_filter_execute(ctx, filter_slice, &td, ((void*)0),
                      ((s->planeheight[1]) > (ff_filter_get_nb_threads(ctx)) ? (ff_filter_get_nb_threads(ctx)) : (s->planeheight[1])));
...
# 363 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_neighbor.c"
static const AVOption options[] = {

    { "coordinates", "set coordinates", __builtin_offsetof(NContext, coordinates), AV_OPT_TYPE_INT, {.i64=255}, 0, 255, (1<<16)|16|(1<<15) },

    { "threshold0", "set threshold for 1st plane", __builtin_offsetof(NContext, threshold[0]), AV_OPT_TYPE_INT, {.i64=65535}, 0, 65535, (1<<16)|16|(1<<15) },
    { "threshold1", "set threshold for 2nd plane", __builtin_offsetof(NContext, threshold[1]), AV_OPT_TYPE_INT, {.i64=65535}, 0, 65535, (1<<16)|16|(1<<15) },
    { "threshold2", "set threshold for 3rd plane", __builtin_offsetof(NContext, threshold[2]), AV_OPT_TYPE_INT, {.i64=65535}, 0, 65535, (1<<16)|16|(1<<15) },
    { "threshold3", "set threshold for 4th plane", __builtin_offsetof(NContext, threshold[3]), AV_OPT_TYPE_INT, {.i64=65535}, 0, 65535, (1<<16)|16|(1<<15) },
    { ((void*)0) }
};

static const AVClass erosion_dilation_class = { .class_name = "erosion/dilation", .item_name = av_default_item_name, .option = options, .version = ((58)<<16 | (36)<<8 | (100)), .category = AV_CLASS_CATEGORY_FILTER, };



const AVFilter ff_vf_erosion = { .name = "erosion", .description = "Apply erosion effect.", .priv_class = &erosion_dilation_class, .priv_size = sizeof(NContext), .inputs = (neighbor_inputs), .nb_inputs = (sizeof((neighbor_inputs)) / sizeof(((neighbor_inputs))[0])), .outputs = (ff_video_default_filterpad), .nb_outputs = (sizeof((ff_video_default_filterpad)) / sizeof(((ff_video_default_filterpad))[0])), .formats.pixels_list = pix_fmts, .formats_state = FF_FILTER_FORMATS_PIXFMT_LIST, .flags = (1 << 16)| (1 << 2), .process_command = ff_filter_process_command, };





const AVFilter ff_vf_dilation = { .name = "dilation", .description = "Apply dilation effect.", .priv_class = &erosion_dilation_class, .priv_size = sizeof(NContext), .inputs = (neighbor_inputs), .nb_inputs = (sizeof((neighbor_inputs)) / sizeof(((neighbor_inputs))[0])), .outputs = (ff_video_default_filterpad), .nb_outputs = (sizeof((ff_video_default_filterpad)) / sizeof(((ff_video_default_filterpad))[0])), .formats.pixels_list = pix_fmts, .formats_state = FF_FILTER_FORMATS_PIXFMT_LIST, .flags = (1 << 16)| (1 << 2), .process_command = ff_filter_process_command, };



static const AVClass deflate_inflate_class = { .class_name = "deflate/inflate", .item_name = av_default_item_name, .option = &options[(1 || 1)], .version = ((58)<<16 | (36)<<8 | (100)), .category = AV_CLASS_CATEGORY_FILTER, };




const AVFilter ff_vf_deflate = { .name = "deflate", .description = "Apply deflate effect.", .priv_class = &deflate_inflate_class, .priv_size = sizeof(NContext), .inputs = (neighbor_inputs), .nb_inputs = (sizeof((neighbor_inputs)) / sizeof(((neighbor_inputs))[0])), .outputs = (ff_video_default_filterpad), .nb_outputs = (sizeof((ff_video_default_filterpad)) / sizeof(((ff_video_default_filterpad))[0])), .formats.pixels_list = pix_fmts, .formats_state = FF_FILTER_FORMATS_PIXFMT_LIST, .flags = (1 << 16)| (1 << 2), .process_command = ff_filter_process_command, };





const AVFilter ff_vf_inflate = { .name = "inflate", .description = "Apply inflate effect.", .priv_class = &deflate_inflate_class, .priv_size = sizeof(NContext), .inputs = (neighbor_inputs), .nb_inputs = (sizeof((neighbor_inputs)) / sizeof(((neighbor_inputs))[0])), .outputs = (ff_video_default_filterpad), .nb_outputs = (sizeof((ff_video_default_filterpad)) / sizeof(((ff_video_default_filterpad))[0])), .formats.pixels_list = pix_fmts, .formats_state = FF_FILTER_FORMATS_PIXFMT_LIST, .flags = (1 << 16)| (1 << 2), .process_command = ff_filter_process_command, };
