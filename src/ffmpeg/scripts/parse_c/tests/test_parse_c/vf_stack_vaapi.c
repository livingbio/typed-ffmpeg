# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
# 24 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c"
# 1 "./config_components.h" 1
# 25 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
...
int av_opt_serialize(void *obj, int opt_flags, int flags, char **buffer,
                     const char key_val_sep, const char pairs_sep);
# 27 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
...
# 29 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
...
# 30 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
...
int av_hwframe_ctx_create_derived(AVBufferRef **derived_frame_ctx,
                                  ...
                                  int flags);
# 31 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
...
# 32 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
# 1 "./libavutil/avassert.h" 1
# 76 "./libavutil/avassert.h"
void av_assert0_fpu(void);
# 33 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
...
# 34 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
...
# 36 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
...
# 29 "/Users/davidchen/repo/ffmpeg/libavfilter/internal.h" 2
...
# 39 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
...
# 40 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
...
# 41 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
...
# 42 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
...
# 43 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vaapi_vpp.h" 1
# 26 "/Users/davidchen/repo/ffmpeg/libavfilter/vaapi_vpp.h"
# 1 "./libavutil/hwcontext_vaapi.h" 1
# 36 "./libavutil/hwcontext_vaapi.h"
enum {
...
# 27 "/Users/davidchen/repo/ffmpeg/libavfilter/vaapi_vpp.h" 2
...
int ff_vaapi_vpp_render_pictures(AVFilterContext *avctx,
                                 ...
                                 int count,
                                 AVFrame *output_frame);
# 44 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
...
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/stack_internal.h" 1
# 22 "/Users/davidchen/repo/ffmpeg/libavfilter/stack_internal.h"
enum {
    STACK_H = 0,
    STACK_V = 1,
    STACK_X = 2
...
static __attribute__((cold)) void stack_uninit(AVFilterContext *avctx);
static int stack_activate(AVFilterContext *avctx);
# 51 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2
...
static int process_frame(FFFrameSync *fs)
{
    ...
    VAProcPipelineParameterBuffer *params = ((void*)0);
    VARectangle *irect = ((void*)0);
    int ret = 0;
    ...
    for (int i = 0; i < avctx->nb_inputs; i++) {
        ...
        av_log(avctx, 48, "stack input %d: %s, %ux%u (%""ll" "d"").\n",
...
static int config_output(AVFilterLink *outlink)
{
    ...
    AVHWFramesContext *hwfc0 = ((void*)0);
    int ret;

    if (inlink0->format != AV_PIX_FMT_VAAPI || !inlink0->hw_frames_ctx || !inlink0->hw_frames_ctx->data) {
        av_log(avctx, 16, "Software pixel format is not supported.\n");
        return (-(22));
    }
    ...
    for (int i = 1; i < sctx->base.nb_inputs; i++) {
        ...
        if (hwfc0->sw_format != hwfc->sw_format) {
            av_log(avctx, 16, "All inputs should have the same underlying software pixel format.\n");
            return (-(22));
        }

        if (hwfc0->device_ctx != hwfc->device_ctx) {
            av_log(avctx, 16, "All inputs should have the same underlying vaapi devices.\n");
            return (-(22));
        }
    }
...
static __attribute__((cold)) void vaapi_stack_uninit(AVFilterContext *avctx)
{
    StackVAAPIContext *sctx = avctx->priv;
...
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/stack_internal.c" 1
# 29 "/Users/davidchen/repo/ffmpeg/libavfilter/stack_internal.c"
...
static int config_comm_output(AVFilterLink *outlink)
{
    ...
    if (sctx->mode == STACK_H) {
        ...
        for (int i = 0; i < sctx->nb_inputs; i++) {
            ...
            do { region->x = width; region->y = 0; region->width = av_rescale(height, inlink->w, inlink->h); region->height = height; } while (0);
        ...
        for (int i = 0; i < sctx->nb_inputs; i++) {
            ...
            do { region->x = 0; region->y = height; region->width = width; region->height = av_rescale(width, inlink->h, inlink->w); } while (0);
        ...
        for (int i = 0; i < sctx->nb_grid_columns; i++) {
            ...
            for (int j = 0; j < sctx->nb_grid_rows; j++) {
                ...
                do { region->x = xpos; region->y = ypos; region->width = ow; region->height = oh; } while (0);
                ypos += oh;
            }
        ...
        char *arg, *p = sctx->layout, *saveptr = ((void*)0);
        ...
        for (int i = 0; i < sctx->nb_inputs; i++) {
            ...
            for (int j = 0; j < 3; j++) {
                ...
                if (j == 2) {
                    if ((ret = av_parse_video_size(&ow, &oh, p3)) < 0) {
                        av_log(avctx, 16, "Invalid size '%s'\n", p3);
                        return ret;
                    }
            ...
            do { region->x = xpos; region->y = ypos; region->width = ow; region->height = oh; } while (0);
            width = ((width) > (xpos + ow) ? (width) : (xpos + ow));
            height = ((height) > (ypos + oh) ? (height) : (ypos + oh));
        }
...
static int stack_init(AVFilterContext *avctx)
{
    ...
    if (!strcmp(avctx->filter->name, "hstack_vaapi"))
        ...
        do { if (!(strcmp(avctx->filter->name, "xstack_vaapi") == 0)) { av_log(((void*)0), 0, "Assertion %s failed at %s:%d\n", "strcmp(avctx->filter->name, \"xstack_vaapi\") == 0", "/Users/davidchen/repo/ffmpeg/libavfilter/stack_internal.c", 235); abort(); } } while (0);
        sctx->mode = STACK_X;
        is_grid = sctx->nb_grid_rows && sctx->nb_grid_columns;

        if (sctx->layout && is_grid) {
            av_log(avctx, 16, "Both layout and grid were specified. Only one is allowed.\n");
            return (-(22));
        }
        ...
        if (!sctx->layout && !is_grid) {
            if (sctx->nb_inputs == 2) {
                ...
                av_log(avctx, 16, "No layout or grid specified.\n");
                return (-(22));
            }
        }
...
# 233 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_stack_vaapi.c" 2



static const AVOption hstack_vaapi_options[] = { { "inputs", "Set number of inputs", __builtin_offsetof(StackVAAPIContext, base.nb_inputs), AV_OPT_TYPE_INT, { .i64 = 2 }, 2, 65535, .flags = (16 | (1<<16)) }, { "shortest", "Force termination when the shortest input terminates", __builtin_offsetof(StackVAAPIContext, base.shortest), AV_OPT_TYPE_BOOL, { .i64 = 0 }, 0, 1, (16 | (1<<16)) }, { "height", "Set output height (0 to use the height of input 0)", __builtin_offsetof(StackVAAPIContext, base.tile_height), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 65535, (16 | (1<<16)) }, { ((void*)0) } };
static const AVClass hstack_vaapi_class = { .class_name = "hstack" "_" "vaapi", .item_name = av_default_item_name, .option = hstack_vaapi_options, .version = ((58)<<16 | (36)<<8 | (100)), }; const AVFilter ff_vf_hstack_vaapi = { .name = "hstack" "_" "vaapi", .description = "\"VA-API\"" " " "hstack", .priv_size = sizeof(StackVAAPIContext), .priv_class = &hstack_vaapi_class, .init = vaapi_stack_init, .uninit = vaapi_stack_uninit, .activate = stack_activate, .formats.query_func = vaapi_stack_query_formats, .formats_state = FF_FILTER_FORMATS_QUERY_FUNC, .outputs = (stack_outputs), .nb_outputs = (sizeof((stack_outputs)) / sizeof(((stack_outputs))[0])), .flags_internal = (1 << 0), .flags = (1 << 0) | 0, };





static const AVOption vstack_vaapi_options[] = { { "inputs", "Set number of inputs", __builtin_offsetof(StackVAAPIContext, base.nb_inputs), AV_OPT_TYPE_INT, { .i64 = 2 }, 2, 65535, .flags = (16 | (1<<16)) }, { "shortest", "Force termination when the shortest input terminates", __builtin_offsetof(StackVAAPIContext, base.shortest), AV_OPT_TYPE_BOOL, { .i64 = 0 }, 0, 1, (16 | (1<<16)) }, { "width", "Set output width (0 to use the width of input 0)", __builtin_offsetof(StackVAAPIContext, base.tile_width), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 65535, (16 | (1<<16)) }, { ((void*)0) } };
static const AVClass vstack_vaapi_class = { .class_name = "vstack" "_" "vaapi", .item_name = av_default_item_name, .option = vstack_vaapi_options, .version = ((58)<<16 | (36)<<8 | (100)), }; const AVFilter ff_vf_vstack_vaapi = { .name = "vstack" "_" "vaapi", .description = "\"VA-API\"" " " "vstack", .priv_size = sizeof(StackVAAPIContext), .priv_class = &vstack_vaapi_class, .init = vaapi_stack_init, .uninit = vaapi_stack_uninit, .activate = stack_activate, .formats.query_func = vaapi_stack_query_formats, .formats_state = FF_FILTER_FORMATS_QUERY_FUNC, .outputs = (stack_outputs), .nb_outputs = (sizeof((stack_outputs)) / sizeof(((stack_outputs))[0])), .flags_internal = (1 << 0), .flags = (1 << 0) | 0, };





static const AVOption xstack_vaapi_options[] = { { "inputs", "Set number of inputs", __builtin_offsetof(StackVAAPIContext, base.nb_inputs), AV_OPT_TYPE_INT, { .i64 = 2 }, 2, 65535, .flags = (16 | (1<<16)) }, { "shortest", "Force termination when the shortest input terminates", __builtin_offsetof(StackVAAPIContext, base.shortest), AV_OPT_TYPE_BOOL, { .i64 = 0 }, 0, 1, (16 | (1<<16)) }, { "layout", "Set custom layout", __builtin_offsetof(StackVAAPIContext, base.layout), AV_OPT_TYPE_STRING, {.str = ((void*)0)}, 0, 0, .flags = (16 | (1<<16)) }, { "grid", "set fixed size grid layout", __builtin_offsetof(StackVAAPIContext, base.nb_grid_columns), AV_OPT_TYPE_IMAGE_SIZE, {.str = ((void*)0)}, 0, 0, .flags = (16 | (1<<16)) }, { "grid_tile_size", "set tile size in grid layout", __builtin_offsetof(StackVAAPIContext, base.tile_width), AV_OPT_TYPE_IMAGE_SIZE, {.str = ((void*)0)}, 0, 0, .flags = (16 | (1<<16)) }, { "fill", "Set the color for unused pixels", __builtin_offsetof(StackVAAPIContext, base.fillcolor_str), AV_OPT_TYPE_STRING, {.str = "none"}, .flags = (16 | (1<<16)) }, { ((void*)0) } };
static const AVClass xstack_vaapi_class = { .class_name = "xstack" "_" "vaapi", .item_name = av_default_item_name, .option = xstack_vaapi_options, .version = ((58)<<16 | (36)<<8 | (100)), }; const AVFilter ff_vf_xstack_vaapi = { .name = "xstack" "_" "vaapi", .description = "\"VA-API\"" " " "xstack", .priv_size = sizeof(StackVAAPIContext), .priv_class = &xstack_vaapi_class, .init = vaapi_stack_init, .uninit = vaapi_stack_uninit, .activate = stack_activate, .formats.query_func = vaapi_stack_query_formats, .formats_state = FF_FILTER_FORMATS_QUERY_FUNC, .outputs = (stack_outputs), .nb_outputs = (sizeof((stack_outputs)) / sizeof(((stack_outputs))[0])), .flags_internal = (1 << 0), .flags = (1 << 0) | 0, };
