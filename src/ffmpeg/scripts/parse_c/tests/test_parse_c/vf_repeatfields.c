# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_repeatfields.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_repeatfields.c" 2
# 21 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_repeatfields.c"
...
# 22 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_repeatfields.c" 2
...
# 23 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_repeatfields.c" 2
...
# 24 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_repeatfields.c" 2
...
# 26 "/Users/davidchen/repo/ffmpeg/libavfilter/vf_repeatfields.c" 2
...
static void update_pts(AVFilterLink *link, AVFrame *f, int64_t pts, int fields)
{
    if (av_cmp_q(link->frame_rate, (AVRational){30000, 1001}) == 0 &&
        ...
        f->pts = ((int64_t)(0x8000000000000000ULL));
}
...
static int filter_frame(AVFilterLink *inlink, AVFrame *in)
{
    ...
    if (!s->frame) {
        ...
        s->frame->pts = ((int64_t)(0x8000000000000000ULL));
    }

    if ((state == 0 && !(in->flags & (1 << 4))) ||
        (state == 1 && (in->flags & (1 << 4)))) {
        av_log(ctx, 24, "Unexpected field flags: "
...
const AVFilter ff_vf_repeatfields = {
    ...
    .uninit = uninit,
    .inputs = (repeatfields_inputs), .nb_inputs = (sizeof((repeatfields_inputs)) / sizeof(((repeatfields_inputs))[0])),
    .outputs = (ff_video_default_filterpad), .nb_outputs = (sizeof((ff_video_default_filterpad)) / sizeof(((ff_video_default_filterpad))[0])),
    .formats.pixels_list = pixel_fmts_eq, .formats_state = FF_FILTER_FORMATS_PIXFMT_LIST,
};
