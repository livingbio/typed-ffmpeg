# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 418 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c" 2
# 26 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c"
...
# 27 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c" 2

# 1 "./libavutil/channel_layout.h" 1
# 25 "./libavutil/channel_layout.h"
...
# 26 "./libavutil/channel_layout.h" 2
...
# 30 "./libavutil/channel_layout.h" 2
...
# 29 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c" 2
...
# 30 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c" 2
...
# 31 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c" 2
...
# 32 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c" 2
...
# 33 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c" 2
# 1 "./libavutil/opt.h" 1
# 223 "./libavutil/opt.h"
enum AVOptionType{
    AV_OPT_TYPE_FLAGS,
...
int av_opt_serialize(void *obj, int opt_flags, int flags, char **buffer,
                     const char key_val_sep, const char pairs_sep);
# 34 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c" 2

# 1 "./libavutil/timestamp.h" 1
# 43 "./libavutil/timestamp.h"
static inline char *av_ts_make_string(char *buf, int64_t ts)
{
    if (ts == ((int64_t)(0x8000000000000000ULL))) __builtin___snprintf_chk (buf, 32, 0, __builtin_object_size (buf, 2 > 1 ? 1 : 0), "NOPTS");
    else __builtin___snprintf_chk (buf, 32, 0, __builtin_object_size (buf, 2 > 1 ? 1 : 0), "%" "ll" "d", ts);
    return buf;
}
# 65 "./libavutil/timestamp.h"
static inline char *av_ts_make_time_string(char *buf, int64_t ts, AVRational *tb)
{
    if (ts == ((int64_t)(0x8000000000000000ULL))) __builtin___snprintf_chk (buf, 32, 0, __builtin_object_size (buf, 2 > 1 ? 1 : 0), "NOPTS");
    else __builtin___snprintf_chk (buf, 32, 0, __builtin_object_size (buf, 2 > 1 ? 1 : 0), "%.6g", av_q2d(*tb) * ts);
    return buf;
}
# 36 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c" 2
...
# 37 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c" 2

# 1 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.h" 1
# 36 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.h"
enum {
...
# 64 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.h"
unsigned av_buffersrc_get_nb_failed_requests(AVFilterContext *buffer_src);
# 73 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.h"
...
# 147 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.h"
int av_buffersrc_parameters_set(AVFilterContext *ctx, AVBufferSrcParameters *param);
# 162 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.h"
__attribute__((warn_unused_result))
int av_buffersrc_write_frame(AVFilterContext *ctx, const AVFrame *frame);
# 183 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.h"
__attribute__((warn_unused_result))
int av_buffersrc_add_frame(AVFilterContext *ctx, AVFrame *frame);
# 201 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.h"
__attribute__((warn_unused_result))
int av_buffersrc_add_frame_flags(AVFilterContext *buffer_src,
                                 AVFrame *frame, int flags);
# 212 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.h"
int av_buffersrc_close(AVFilterContext *ctx, int64_t pts, unsigned flags);
# 39 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c" 2
...
# 40 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c" 2
...
# 41 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c" 2
...
# 43 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c" 2
...
# 85 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c"
AVBufferSrcParameters *av_buffersrc_parameters_alloc(void)
{
...
# 130 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c"
...
#pragma GCC diagnostic push
# 184 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c"
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
    if (frame && frame->channel_layout &&
        av_get_channel_layout_nb_channels(frame->channel_layout) != frame->channels) {
        av_log(ctx, 16, "Layout indicates a different number of channels than actually present\n");
        return (-(22));
    }
#pragma GCC diagnostic pop
    ...
    if (!(flags & AV_BUFFERSRC_FLAG_NO_CHECK_FORMAT)) {
        ...
        case AVMEDIA_TYPE_VIDEO:
            if (s->w != frame->width || s->h != frame->height || s->pix_fmt != frame->format) { av_log(ctx, 32, "filter context - w: %d h: %d fmt: %d, incoming frame - w: %d h: %d fmt: %d pts_time: %s\n", s->w, s->h, s->pix_fmt, frame->width, frame->height, frame->format, av_ts_make_time_string((char[32]){0}, frame->pts, &ctx->outputs[0]->time_base)); av_log(ctx, 24, "Changing video frame properties on the fly is not supported by all filters.\n"); };
...
#pragma GCC diagnostic push
# 214 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c"
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
...
#pragma GCC diagnostic pop
            ...
            if (s->sample_fmt != frame->format || s->sample_rate != frame->sample_rate || av_channel_layout_compare(&s->ch_layout, &frame->ch_layout) || s->channels != frame->ch_layout.nb_channels) { av_log(ctx, 32, "filter context - fmt: %s r: %d layout: %""ll" "X"" ch: %d, incoming frame - fmt: %s r: %d layout: %""ll" "X"" ch: %d pts_time: %s\n", av_get_sample_fmt_name(s->sample_fmt), s->sample_rate, s->ch_layout.order == AV_CHANNEL_ORDER_NATIVE ? s->ch_layout.u.mask : 0, s->channels, av_get_sample_fmt_name(frame->format), frame->sample_rate, frame->ch_layout.order == AV_CHANNEL_ORDER_NATIVE ? frame->ch_layout.u.mask : 0, frame->ch_layout.nb_channels, av_ts_make_time_string((char[32]){0}, frame->pts, &ctx->outputs[0]->time_base)); av_log(ctx, 16, "Changing audio frame properties on the fly is not supported.\n"); return (-(22)); };
...
#pragma GCC diagnostic push
# 245 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c"
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
...
#pragma GCC diagnostic push
# 252 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c"
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
...
#pragma GCC diagnostic push
# 261 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c"
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
    if (copy->key_frame)
        copy->flags |= (1 << 1);
#pragma GCC diagnostic pop
...
int av_buffersrc_close(AVFilterContext *ctx, int64_t pts, unsigned flags)
{
    ...
    s->eof = 1;
    ff_avfilter_link_set_in_status(ctx->outputs[0], (-(int)(('E') | (('O') << 8) | (('F') << 16) | ((unsigned)(' ') << 24))), pts);
    return (flags & AV_BUFFERSRC_FLAG_PUSH) ? push_frame(ctx->graph) : 0;
}

static __attribute__((cold)) int init_video(AVFilterContext *ctx)
{
    BufferSourceContext *c = ctx->priv;

    if (c->pix_fmt == AV_PIX_FMT_NONE) {
        av_log(ctx, 16, "Unspecified pixel format\n");
        return (-(22));
    }
    if (c->w <= 0 || c->h <= 0) {
        av_log(ctx, 16, "Invalid size %dx%d\n", c->w, c->h);
        return (-(22));
    }
    if (av_q2d(c->time_base) <= 0) {
        av_log(ctx, 16, "Invalid time base %d/%d\n", c->time_base.num, c->time_base.den);
        return (-(22));
    }

    av_log(ctx, 40, "w:%d h:%d pixfmt:%s tb:%d/%d fr:%d/%d sar:%d/%d\n",
...
static const AVOption buffer_options[] = {
    { "width", ((void*)0), __builtin_offsetof(BufferSourceContext, w), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 2147483647, (1<<16)|16 },
    { "video_size", ((void*)0), __builtin_offsetof(BufferSourceContext, w), AV_OPT_TYPE_IMAGE_SIZE, .flags = (1<<16)|16 },
    { "height", ((void*)0), __builtin_offsetof(BufferSourceContext, h), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 2147483647, (1<<16)|16 },
    { "pix_fmt", ((void*)0), __builtin_offsetof(BufferSourceContext, pix_fmt), AV_OPT_TYPE_PIXEL_FMT, { .i64 = AV_PIX_FMT_NONE }, .min = AV_PIX_FMT_NONE, .max = 2147483647, .flags = (1<<16)|16 },
    { "sar", "sample aspect ratio", __builtin_offsetof(BufferSourceContext, pixel_aspect), AV_OPT_TYPE_RATIONAL, { .dbl = 0 }, 0, 1.7976931348623157e+308, (1<<16)|16 },
    { "pixel_aspect", "sample aspect ratio", __builtin_offsetof(BufferSourceContext, pixel_aspect), AV_OPT_TYPE_RATIONAL, { .dbl = 0 }, 0, 1.7976931348623157e+308, (1<<16)|16 },
    { "time_base", ((void*)0), __builtin_offsetof(BufferSourceContext, time_base), AV_OPT_TYPE_RATIONAL, { .dbl = 0 }, 0, 1.7976931348623157e+308, (1<<16)|16 },
    { "frame_rate", ((void*)0), __builtin_offsetof(BufferSourceContext, frame_rate), AV_OPT_TYPE_RATIONAL, { .dbl = 0 }, 0, 1.7976931348623157e+308, (1<<16)|16 },
    { ((void*)0) },
};

static const AVClass buffer_class = { .class_name = "buffer", .item_name = av_default_item_name, .option = buffer_options, .version = ((58)<<16 | (36)<<8 | (100)), .category = AV_CLASS_CATEGORY_FILTER, };

static const AVOption abuffer_options[] = {
    { "time_base", ((void*)0), __builtin_offsetof(BufferSourceContext, time_base), AV_OPT_TYPE_RATIONAL, { .dbl = 0 }, 0, 2147483647, (1<<16)|8 },
    { "sample_rate", ((void*)0), __builtin_offsetof(BufferSourceContext, sample_rate), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 2147483647, (1<<16)|8 },
    { "sample_fmt", ((void*)0), __builtin_offsetof(BufferSourceContext, sample_fmt), AV_OPT_TYPE_SAMPLE_FMT, { .i64 = AV_SAMPLE_FMT_NONE }, .min = AV_SAMPLE_FMT_NONE, .max = 2147483647, .flags = (1<<16)|8 },
    { "channel_layout", ((void*)0), __builtin_offsetof(BufferSourceContext, channel_layout_str), AV_OPT_TYPE_STRING, .flags = (1<<16)|8 },
    { "channels", ((void*)0), __builtin_offsetof(BufferSourceContext, channels), AV_OPT_TYPE_INT, { .i64 = 0 }, 0, 2147483647, (1<<16)|8 },
    { ((void*)0) },
};

static const AVClass abuffer_class = { .class_name = "abuffer", .item_name = av_default_item_name, .option = abuffer_options, .version = ((58)<<16 | (36)<<8 | (100)), .category = AV_CLASS_CATEGORY_FILTER, };

static __attribute__((cold)) int init_audio(AVFilterContext *ctx)
{
    BufferSourceContext *s = ctx->priv;
    char buf[128];
    int ret = 0;
    ...
    if (s->sample_fmt == AV_SAMPLE_FMT_NONE) {
        av_log(ctx, 16, "Sample format was not set or was invalid\n");
        return (-(22));
    }
    ...
    if (s->channel_layout_str || s->ch_layout.nb_channels) {
        ...
        if (!s->ch_layout.nb_channels) {
            ...
            if (ret < 0) {
                ...
                uint64_t mask;
#pragma GCC diagnostic push
# 367 "/Users/davidchen/repo/ffmpeg/libavfilter/buffersrc.c"
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
                mask = av_get_channel_layout(s->channel_layout_str);
                if (!mask) {

                    av_log(ctx, 16, "Invalid channel layout %s.\n",
                           s->channel_layout_str);
                    return (-(22));

                }
#pragma GCC diagnostic pop
                av_log(ctx, 24, "Channel layout '%s' uses a deprecated syntax.\n",
                       s->channel_layout_str);
        ...
        av_log(ctx, 16, "Neither number of channels nor "
                                  "channel layout specified\n");
        return (-(22));
    } else {
        s->ch_layout = ((AVChannelLayout) { .order = AV_CHANNEL_ORDER_UNSPEC, .nb_channels = s->channels });
        av_channel_layout_describe(&s->ch_layout, buf, sizeof(buf));
    }
...
static int activate(AVFilterContext *ctx)
{
    ...
    if (c->eof) {
        ff_outlink_set_status(outlink, (-(int)(('E') | (('O') << 8) | (('F') << 16) | ((unsigned)(' ') << 24))), c->last_pts);
        return 0;
    }
...
const AVFilter ff_vsrc_buffer = {
    ...
    .inputs = ((void*)0),
    .outputs = (avfilter_vsrc_buffer_outputs), .nb_outputs = (sizeof((avfilter_vsrc_buffer_outputs)) / sizeof(((avfilter_vsrc_buffer_outputs))[0])),
...
const AVFilter ff_asrc_abuffer = {
    ...
    .inputs = ((void*)0),
    .outputs = (avfilter_asrc_abuffer_outputs), .nb_outputs = (sizeof((avfilter_asrc_abuffer_outputs)) / sizeof(((avfilter_asrc_abuffer_outputs))[0])),
    .formats.query_func = query_formats, .formats_state = FF_FILTER_FORMATS_QUERY_FUNC,
