...
class TestGlobalRunable:
    """Test cases for the GlobalRunable class."""

    def test_use_filter_complex_script_parameter(self) -> None:
    ...
    def test_use_filter_complex_script_with_run_method(self) -> None:
    ...
    def test_use_filter_complex_script_with_compile_line(self) -> None:
